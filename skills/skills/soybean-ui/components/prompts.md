...
Usage examples for prompts are rendered on the site.
...
Interactive demos for prompts are rendered on the site.

## API

Structured API summary generated from build-time component metadata.

- Exported symbols (1): Prompts.
...
- `prompts`: The prompts to display. (type `Prompt[]`; required)
- `onSelect`: Emitted when a prompt is clicked. (type `((prompt: Prompt) => void)`; optional)
