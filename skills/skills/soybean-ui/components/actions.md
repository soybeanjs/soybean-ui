...
Usage examples for actions are rendered on the site.
...
Interactive demos for actions are rendered on the site.

## API

Structured API summary generated from build-time component metadata.

- Exported symbols (1): Actions.
...
- `items`: The actions to display. (type `ActionItem[]`; optional)
