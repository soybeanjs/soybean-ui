...
Source URL: https://veanui.com/components/toggle-group
Markdown URL: https://veanui.com/components/toggle-group.md
Category: Forms
...
| Capability                        | Vean | Ant Design | Element Plus | Mantine | Naive UI | shadcn `ToggleGroup` |
| :-------------------------------- | :--: | :--------: | :----------: | :-----: | :------: | :------------------: |
