...
Pass `class="w-full"` (or `fitContent` for the opposite effect). Vean does not add a `block` prop because UnoCSS utilities cover this without expanding the API surface.
