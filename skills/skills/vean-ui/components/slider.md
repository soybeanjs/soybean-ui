...
Source URL: https://veanui.com/components/slider
Markdown URL: https://veanui.com/components/slider.md
Category: Forms
...
| Capability                          | Vean | Ant Design `Slider` | Element Plus `Slider` | Mantine `Slider` | Naive UI `Slider` | shadcn `Slider` |
| :---------------------------------- | :--: | :-----------------: | :-------------------: | :--------------: | :---------------: | :-------------: |
