import { isNullish } from '@soybeanjs/headless/shared';
import type { Direction, Align, InferDefaults, Placement } from '@soybeanjs/headless/types';
...
import type { EpPositionerProps } from './types';
...
export function createEpPositionerDefaultProps() {
  const props: InferDefaults<EpPositionerProps> = {
    placement: undefined,
    side: 'bottom',
    sideOffset: 0,
    sideFlip: true,
...
export function getFloatingUiMiddleware(props: EpPositionerProps, arrowElement: Element | null | undefined) {
  const {
    sideOffset = 0,
    alignOffset = 0,
    sideFlip,
...
function getDetectOverflowOptions(props: EpPositionerProps) {
