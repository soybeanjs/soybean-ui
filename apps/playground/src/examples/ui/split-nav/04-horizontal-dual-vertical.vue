...
<template>
  <div class="relative flex h-110 w-fit flex-col border rounded-md bg-sidebar">
    <SButtonIcon
    ...
    />
    <SSplitNav v-model="active" v-model:collapsed="collapsed" mode="horizontal-dual-vertical" :items="splitNavItems" />
  </div>
</template>
