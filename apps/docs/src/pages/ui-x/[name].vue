...
const importName = computed(() => `Sx${componentName.value}`);
...
const currentGroup = computed(() => {
  return uiXMenuData.find(group => group.items.some(item => kebabCase(item) === name.value));
});

const currentGroupLabel = computed(() => {
  return currentGroup.value ? t(currentGroup.value.i18n) : t('layout.header.ui_x');
});
  ...
  <div class="mx-auto max-w-screen-2xl space-y-6 pb-8">
    ...
    >
      ...
      <div class="relative grid gap-8 xl:grid-cols-[minmax(0,1.12fr)_22rem] xl:items-start">
        <div class="space-y-6">
          <SButtonLink to="/ui-x" size="sm" variant="ghost" color="accent" class="group -ml-2">
          ...
          <div class="space-y-5">
            ...
            <div class="space-y-4">
              <div class="flex flex-wrap items-center gap-2.5">
                ...
                <div class="code-btn-outline">@soybeanjs/ui-x</div>
