...
import { ref } from 'vue';
import { SRadioGroupCard } from '@vean/ui';
import type { RadioGroupCardOptionData } from '@vean/ui';
...
const items: RadioGroupCardOptionData<string>[] = [
  ...
  { icon: 'lucide:grape', value: 'grape', label: 'Grape', description: 'This is a grape' }
];
</script>
