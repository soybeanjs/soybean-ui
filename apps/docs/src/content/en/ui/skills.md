...
head:
  title: Skills
  description: 'Install Vean skills to give AI coding agents deep knowledge of components, theming, aria composition patterns, and generated references.'
---

# Skills

> Install Vean skills to give AI coding agents deep knowledge of components, theming, aria composition patterns, and generated references.
...
Vean currently ships two public skills:
...
> **Repository rename not yet live.** Every installation path on this page resolves skills from GitHub, so the commands below only work once the repository rename `soybeanjs/soybean-ui` → `soybeanjs/vean` has landed. Until then `github.com/soybeanjs/vean` returns 404 — use the current slug `soybeanjs/soybean-ui` instead, for example `npx skills add soybeanjs/soybean-ui/skills`.
...
```bash
npx skills add soybeanjs/vean/skills --agent cursor
npx skills add soybeanjs/vean/skills --agent claude-code
```

Or install globally so the skills are available across projects:

```bash
npx skills add soybeanjs/vean/skills --global
```
...
```text
https://github.com/soybeanjs/vean/tree/main/skills/skills/vean-ui
```

For the aria skill:

```text
https://github.com/soybeanjs/vean/tree/main/skills/skills/vean-aria
```
...
```bash
claude skill add https://github.com/soybeanjs/vean/tree/main/skills/skills/vean-ui
claude skill add https://github.com/soybeanjs/vean/tree/main/skills/skills/vean-aria
```
...
- **Vean skill entry**: https://github.com/soybeanjs/vean/tree/main/skills/skills/vean-ui/SKILL.md
- **Vean skill directory**: https://github.com/soybeanjs/vean/tree/main/skills/skills/vean-ui
- **Vean Aria skill entry**: https://github.com/soybeanjs/vean/tree/main/skills/skills/vean-aria/SKILL.md
- **Vean Aria skill directory**: https://github.com/soybeanjs/vean/tree/main/skills/skills/vean-aria
