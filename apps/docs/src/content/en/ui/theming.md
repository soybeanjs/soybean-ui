...
| `overrides`     | `{ light?: { [token]: ColorValue }, dark?: … }`                                    | —           | Per-mode token overrides — the sharpest tool; see below.                                                         |
