...
LLMs.txt is a structured documentation format for large language models. Vean generates dedicated LLM-friendly files during the docs build so AI tools can consume the library docs, API details, and usage guidance more reliably than by reading the rendered website alone.

The generated files are optimized for AI consumption and currently use the English docs set as the source of truth.

## Available routes

Vean exposes the following LLM-oriented routes from the docs build output:
...
You can reference Vean docs routes directly in Cursor prompts or add them through docs-based context features.

Examples:

- Use https://veanui.com/llms.txt as the Vean docs context
- Follow Vean component guidance from https://veanui.com/components/button.md
...
- Follow Vean docs from https://veanui.com/llms.txt
- Use the Button page from https://veanui.com/components/button.md
- Use the full Vean bundle from https://veanui.com/llms-full.txt
