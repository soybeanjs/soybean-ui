...
head:
  title: Vean CLI
  description: 'vean is the command-line tool for Vean. It helps you initialize projects, add components, manage your UI configuration, and migrate a project to Vean.'
---

# Vean CLI

`vean` is the command-line tool for Vean. It helps you initialize projects, add components, manage your UI configuration, and migrate a project to Vean.
