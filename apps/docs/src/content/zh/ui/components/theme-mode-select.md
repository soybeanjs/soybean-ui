...
head:
  title: 主题模式选择
  description: SThemeModeSelect 是一个绑定到当前 SConfigProvider 主题的上下文下拉选择。它提供 ThemeModePreference 的三种选项 —— auto（跟随系统 prefers-color-scheme）、light 与 dark —— 每项均带方案图标，让用户直接选择色彩方案偏好。
---
