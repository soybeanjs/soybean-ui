...
head:
  title: 颜色滑块
  description: 单通道颜色滑块，适合编辑色相、透明度以及 RGB/HSL/HSV/OKLCH 的独立通道。SColorSlider 组合 headless ColorSliderRoot/ColorSliderTrack/ColorSliderThumb 基础组件与共享 sliderVariants 样式配方。
---
