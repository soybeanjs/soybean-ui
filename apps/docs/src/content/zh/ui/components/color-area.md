...
head:
  title: 颜色区域
  description: 二维颜色编辑区域，可在饱和度/明度、饱和度/亮度或 OKLCH 的色度/明度之间拖拽选择。SColorArea 组合 headless ColorAreaRoot/ColorAreaArea/ColorAreaThumb 基础组件与 colorAreaVariants 样式配方（3 个槽、6 种尺寸）。
---
