...
head:
  title: 颜色输入框
  description: 用于编辑完整颜色字符串或单个颜色通道，支持 hex、rgb、hsl 和 oklch 输出格式。SColorField 组合 headless ColorFieldRoot/ColorFieldInput 基础组件与 colorFieldVariants 样式配方（2 个槽、6 种尺寸）。
---
