...
head:
  title: 卡片
  description: 将相关内容与操作分组到带边框、带阴影表面中的容器组件。SCard 组合 CardRoot/CardHeader/CardContent/CardFooter/CardTitle/CardDescription 这一系列 headless 基础组件（零样式）与 cardVariants 样式配方（8 个槽、6 种尺寸、scrollable/split 开关）。
---
