...
- **components**:
  - keep persisted theme flash-free across refresh &nbsp;-&nbsp; by @soybeanjs [<samp>(5efd8)</samp>](https://github.com/soybeanjs/soybean-ui/commit/5efd8c7dd)
- **docs**:
  - upgrade ubean@0.4.5 for SSG direct render &nbsp;-&nbsp; by **soybeanfe** [<samp>(488b5)</samp>](https://github.com/soybeanjs/soybean-ui/commit/488b5a861)
  - apply persisted theme CSS before first paint &nbsp;-&nbsp; by @soybeanjs [<samp>(83434)</samp>](https://github.com/soybeanjs/soybean-ui/commit/8343441ae)
  - bind ConfigProvider locale to i18n locale &nbsp;-&nbsp; by @soybeanjs [<samp>(43fe4)</samp>](https://github.com/soybeanjs/soybean-ui/commit/43fe44bb4)
  - add playground page with examples of all libraries &nbsp;-&nbsp; by @soybeanjs [<samp>(e7793)</samp>](https://github.com/soybeanjs/soybean-ui/commit/e77938392)
  - full-text content search backed by @ubean/content and API index &nbsp;-&nbsp; by @soybeanjs [<samp>(1d3bb)</samp>](https://github.com/soybeanjs/soybean-ui/commit/1d3bbba00)
  - generate API data for chart, admin and headless packages &nbsp;-&nbsp; by **soybeanfe** [<samp>(9ffc1)</samp>](https://github.com/soybeanjs/soybean-ui/commit/9ffc1b5bc)
  - highlight search matches and tighten content search &nbsp;-&nbsp; by **soybeanfe** [<samp>(bd5f9)</samp>](https://github.com/soybeanjs/soybean-ui/commit/bd5f94ad4)
...
- **headless**:
  - add snakeCase string util &nbsp;-&nbsp; by **soybeanfe** [<samp>(8af73)</samp>](https://github.com/soybeanjs/soybean-ui/commit/8af733848)
...
- **link**:
  - add linkComponent injection via ConfigProvider &nbsp;-&nbsp; by **soybeanfe** [<samp>(3fd7f)</samp>](https://github.com/soybeanjs/soybean-ui/commit/3fd7f2b12)
- **nav-menu**:
  - add selected state support for nav menu options &nbsp;-&nbsp; by **soybeanfe** [<samp>(b903d)</samp>](https://github.com/soybeanjs/soybean-ui/commit/b903de1b3)
- **projects**:
  - add new docs &nbsp;-&nbsp; by **soybeanfe** [<samp>(2d96c)</samp>](https://github.com/soybeanjs/soybean-ui/commit/2d96c6048)
- **scripts**:
...
- **split-nav**:
  - focus the first pane item on the forward expand key &nbsp;-&nbsp; by **soybeanfe** [<samp>(25d28)</samp>](https://github.com/soybeanjs/soybean-ui/commit/25d288557)
  - fall back focus to the owning rail item via the backward key &nbsp;-&nbsp; by **soybeanfe** [<samp>(f0e55)</samp>](https://github.com/soybeanjs/soybean-ui/commit/f0e554b93)
- **theme**:
  - persist generated theme CSS for pre-paint application &nbsp;-&nbsp; by @soybeanjs [<samp>(ed239)</samp>](https://github.com/soybeanjs/soybean-ui/commit/ed239dc4a)
- **tree-menu**:
  - keyboard navigation for the collapsed dropdown popup &nbsp;-&nbsp; by **soybeanfe** [<samp>(c2a44)</samp>](https://github.com/soybeanjs/soybean-ui/commit/c2a440c77)
- **ui**:
  - support item description and external search filtering in command &nbsp;-&nbsp; by @soybeanjs [<samp>(73801)</samp>](https://github.com/soybeanjs/soybean-ui/commit/73801c152)
- **uno**:
  - add scrollbar preset and injection options for built-in presets &nbsp;-&nbsp; by **soybeanfe** [<samp>(4d95c)</samp>](https://github.com/soybeanjs/soybean-ui/commit/4d95cdc7c)

### &nbsp;&nbsp;&nbsp;🐞 Bug Fixes

- **anchor**:
  - preserve history state in hash sync &nbsp;-&nbsp; by **soybeanfe** [<samp>(a2a1e)</samp>](https://github.com/soybeanjs/soybean-ui/commit/a2a1e97d9)
- **build**:
  - include component templates in styles.css output &nbsp;-&nbsp; by **soybeanfe** [<samp>(a7437)</samp>](https://github.com/soybeanjs/soybean-ui/commit/a7437aa72)
- **color-picker**:
  - restore format segment indicator styles &nbsp;-&nbsp; by **soybeanfe** [<samp>(23ad8)</samp>](https://github.com/soybeanjs/soybean-ui/commit/23ad8a5eb)
- **components**:
  - await async renderComponent in browser e2e specs &nbsp;-&nbsp; by @soybeanjs [<samp>(32924)</samp>](https://github.com/soybeanjs/soybean-ui/commit/329245cc0)
  - stop duplicating class on Link root &nbsp;-&nbsp; by **soybeanfe** [<samp>(e8542)</samp>](https://github.com/soybeanjs/soybean-ui/commit/e8542e518)
- **dialog**:
  ...
  - restore fullscreen toggle visible by default &nbsp;-&nbsp; by **soybeanfe** [<samp>(600a0)</samp>](https://github.com/soybeanjs/soybean-ui/commit/600a06669)
  - hide fullscreen toggle by default &nbsp;-&nbsp; by **soybeanfe** [<samp>(3ae1c)</samp>](https://github.com/soybeanjs/soybean-ui/commit/3ae1c91e1)
- **docs**:
  - allow hydration mismatch for async markdown content &nbsp;-&nbsp; by **soybeanfe** [<samp>(706ee)</samp>](https://github.com/soybeanjs/soybean-ui/commit/706ee6756)
  - resolve anchor outline hydration mismatches &nbsp;-&nbsp; by **soybeanfe** [<samp>(dd8ce)</samp>](https://github.com/soybeanjs/soybean-ui/commit/dd8ce0b27)
  - fix hydration mismatch by ClientOnly &nbsp;-&nbsp; by **soybeanfe** [<samp>(f54a9)</samp>](https://github.com/soybeanjs/soybean-ui/commit/f54a99f21)
...
- **dropdown-menu**:
  - guard empty popup id in trigger blur close &nbsp;-&nbsp; by **soybeanfe** [<samp>(38f5e)</samp>](https://github.com/soybeanjs/soybean-ui/commit/38f5e5b75)
- **headless**:
  - avoid recursive update loop in collection item cleanup &nbsp;-&nbsp; by **soybeanfe** [<samp>(4fb09)</samp>](https://github.com/soybeanjs/soybean-ui/commit/4fb090d4a)
  - remove v-memo from ListboxItem to restore slot re-renders &nbsp;-&nbsp; by **soybeanfe** [<samp>(16ce9)</samp>](https://github.com/soybeanjs/soybean-ui/commit/16ce9ac77)
  ...
  - drop S-prefixed component names from headless layer &nbsp;-&nbsp; by @soybeanjs [<samp>(3d9ed)</samp>](https://github.com/soybeanjs/soybean-ui/commit/3d9ed813d)
- **icon**:
  - allow hydration mismatch for async-loaded icons &nbsp;-&nbsp; by **soybeanfe** [<samp>(17a16)</samp>](https://github.com/soybeanjs/soybean-ui/commit/17a16fa53)
- **locale**:
  - fix locale-toggler and unify locale code &nbsp;-&nbsp; by **soybeanfe** [<samp>(27a41)</samp>](https://github.com/soybeanjs/soybean-ui/commit/27a41be8c)
- **nav-menu**:
  - allow sub link label to wrap &nbsp;-&nbsp; by **soybeanfe** [<samp>(ad3a7)</samp>](https://github.com/soybeanjs/soybean-ui/commit/ad3a73eba)
- **progress**:
  - fix progress hydration style &nbsp;-&nbsp; by **soybeanfe** [<samp>(3f9c7)</samp>](https://github.com/soybeanjs/soybean-ui/commit/3f9c7a42d)
- **scripts**:
  - surface changelog breaking entries in docs &nbsp;-&nbsp; by @soybeanjs [<samp>(33f85)</samp>](https://github.com/soybeanjs/soybean-ui/commit/33f859dde)
- **theme**:
  - restore persisted theme after hydration refresh &nbsp;-&nbsp; by **soybeanfe** [<samp>(e3418)</samp>](https://github.com/soybeanjs/soybean-ui/commit/e3418e122)
- **toast**:
  - constrain top-position translateY to pre-mount state &nbsp;-&nbsp; by **soybeanfe** [<samp>(bd52d)</samp>](https://github.com/soybeanjs/soybean-ui/commit/bd52dc3f4)
- **tree-menu**:
  - seed collapsed dropdown open state from dropdownMenuProps &nbsp;-&nbsp; by **soybeanfe** [<samp>(e94f0)</samp>](https://github.com/soybeanjs/soybean-ui/commit/e94f0626f)
- **tree-nav**:
  - menubar-style arrow switching for open branch popups &nbsp;-&nbsp; by **soybeanfe** [<samp>(f136e)</samp>](https://github.com/soybeanjs/soybean-ui/commit/f136eb2dd)
- **ui**:
...
- **ui-x**:
  - remove useless prop codeRender in MarkdownRender &nbsp;-&nbsp; by @soybeanjs [<samp>(08e0c)</samp>](https://github.com/soybeanjs/soybean-ui/commit/08e0c06c1)

### &nbsp;&nbsp;&nbsp;🛠 Optimizations

- **projects**:
  - optimize deps and build config &nbsp;-&nbsp; by **soybeanfe** [<samp>(8d981)</samp>](https://github.com/soybeanjs/soybean-ui/commit/8d981e758)
  - optimize build config &nbsp;-&nbsp; by **soybeanfe** [<samp>(e4606)</samp>](https://github.com/soybeanjs/soybean-ui/commit/e46064391)
- **shared**:
  - optimize kebabCase &nbsp;-&nbsp; by **soybeanfe** [<samp>(aec51)</samp>](https://github.com/soybeanjs/soybean-ui/commit/aec51770c)
- **style**:
  - replace "flex-shrink-0" with "shrink-0" for consistent styling &nbsp;-&nbsp; by @soybeanjs [<samp>(5b11a)</samp>](https://github.com/soybeanjs/soybean-ui/commit/5b11a7ccf)
- **styles**:
  - optimize components styles &nbsp;-&nbsp; by **soybeanfe** [<samp>(52ca7)</samp>](https://github.com/soybeanjs/soybean-ui/commit/52ca72f49)
- **table**:
  - update rounded prop to false in table styles and components &nbsp;-&nbsp; by **soybeanfe** [<samp>(6c496)</samp>](https://github.com/soybeanjs/soybean-ui/commit/6c4969622)

### &nbsp;&nbsp;&nbsp;💅 Refactors

- **components**:
  - inject config provider context via shallowReadonly &nbsp;-&nbsp; by @soybeanjs [<samp>(cdb81)</samp>](https://github.com/soybeanjs/soybean-ui/commit/cdb81973f)
  - resolve config provider context via shared inject keys &nbsp;-&nbsp; by @soybeanjs [<samp>(669e0)</samp>](https://github.com/soybeanjs/soybean-ui/commit/669e0ebfe)
- **dialog**:
  - remove redundant showFullscreen default &nbsp;-&nbsp; by **soybeanfe** [<samp>(956d7)</samp>](https://github.com/soybeanjs/soybean-ui/commit/956d75938)
- **docs**:
  - extract shared toHeadingId helper &nbsp;-&nbsp; by **soybeanfe** [<samp>(191cb)</samp>](https://github.com/soybeanjs/soybean-ui/commit/191cbd596)
  - drop manrope and es-toolkit deps in favor of workspace assets &nbsp;-&nbsp; by **soybeanfe** [<samp>(a77b6)</samp>](https://github.com/soybeanjs/soybean-ui/commit/a77b6e086)
  - merge 404 page into catch-all with blank layout &nbsp;-&nbsp; by **soybeanfe** [<samp>(fdc47)</samp>](https://github.com/soybeanjs/soybean-ui/commit/fdc479d27)
  - integrate ubean Link via linkComponent injection &nbsp;-&nbsp; by **soybeanfe** [<samp>(f9cae)</samp>](https://github.com/soybeanjs/soybean-ui/commit/f9caee6b5)
  - optimize docs header nav menu &nbsp;-&nbsp; by **soybeanfe** [<samp>(e81af)</samp>](https://github.com/soybeanjs/soybean-ui/commit/e81afee65)
  - streamline component detail page hero layout &nbsp;-&nbsp; by **soybeanfe** [<samp>(f84b0)</samp>](https://github.com/soybeanjs/soybean-ui/commit/f84b07293)
  - streamline ui-x component detail hero layout &nbsp;-&nbsp; by **soybeanfe** [<samp>(5d778)</samp>](https://github.com/soybeanjs/soybean-ui/commit/5d778f027)
  - remove top bar and simplify header toolbar &nbsp;-&nbsp; by @soybeanjs [<samp>(1fcb1)</samp>](https://github.com/soybeanjs/soybean-ui/commit/1fcb159ab)
  - detect header scroll state via IntersectionObserver sentinel &nbsp;-&nbsp; by @soybeanjs [<samp>(85336)</samp>](https://github.com/soybeanjs/soybean-ui/commit/853361437)
  - extract markdown highlight logic to build/highlight.ts &nbsp;-&nbsp; by @soybeanjs [<samp>(4a9ef)</samp>](https://github.com/soybeanjs/soybean-ui/commit/4a9ef0734)
  - move catalog page copy into indexed markdown &nbsp;-&nbsp; by **soybeanfe** [<samp>(96638)</samp>](https://github.com/soybeanjs/soybean-ui/commit/966382ed1)
  - drop sidebar expanded workaround handled by tree-menu &nbsp;-&nbsp; by **soybeanfe** [<samp>(77eba)</samp>](https://github.com/soybeanjs/soybean-ui/commit/77eba6080)
- **docs-new**:
  - use app.vue add AppRoot &nbsp;-&nbsp; by **soybeanfe** [<samp>(65f67)</samp>](https://github.com/soybeanjs/soybean-ui/commit/65f67d4ed)
- **headless**:
  - replace external utils with local shared implementations and add unit tests &nbsp;-&nbsp; by **soybeanfe** [<samp>(6b7f4)</samp>](https://github.com/soybeanjs/soybean-ui/commit/6b7f46fee)
  - unify context building into toContext/fromContext &nbsp;-&nbsp; by **soybeanfe** [<samp>(a6df3)</samp>](https://github.com/soybeanjs/soybean-ui/commit/a6df352ae)
  - replace roving-focus components with composable hooks &nbsp;-&nbsp; by @soybeanjs [<samp>(6062d)</samp>](https://github.com/soybeanjs/soybean-ui/commit/6062db00b)
- **projects**:
  - migrate repo scripts into @soybeanjs/scripts package &nbsp;-&nbsp; by @soybeanjs [<samp>(e5f2e)</samp>](https://github.com/soybeanjs/soybean-ui/commit/e5f2e7a4b)
  - remove `@soybeanjs/utils` and update sbean schema &nbsp;-&nbsp; by **soybeanfe** [<samp>(574bd)</samp>](https://github.com/soybeanjs/soybean-ui/commit/574bd9c99)
  - refactor docs use ubean &nbsp;-&nbsp; by **soybeanfe** [<samp>(b394c)</samp>](https://github.com/soybeanjs/soybean-ui/commit/b394ca8c1)
- **repo**:
  - remove admin/chart packages and rebuild chart demos on TanStack Charts &nbsp;-&nbsp; by **soybeanfe** [<samp>(fc490)</samp>](https://github.com/soybeanjs/soybean-ui/commit/fc49068c7)
  - remove @soybeanjs/ui-x and move ai plan to core packages &nbsp;-&nbsp; by @soybeanjs [<samp>(53947)</samp>](https://github.com/soybeanjs/soybean-ui/commit/539479458)
- **sbean**:
  - migrate package directory to packages/cli &nbsp;-&nbsp; by @soybeanjs [<samp>(4a5bd)</samp>](https://github.com/soybeanjs/soybean-ui/commit/4a5bdeb7d)
- **scripts**:
  - align sui commands with ubean-style gen dispatch &nbsp;-&nbsp; by @soybeanjs [<samp>(48da5)</samp>](https://github.com/soybeanjs/soybean-ui/commit/48da58c75)
  - extract shared catalog generator aligned with ubean structure &nbsp;-&nbsp; by @soybeanjs [<samp>(6cd7b)</samp>](https://github.com/soybeanjs/soybean-ui/commit/6cd7b28cc)
- **shared**:
  - introduce source-distributed @soybeanjs/shared package &nbsp;-&nbsp; by **soybeanfe** [<samp>(c6919)</samp>](https://github.com/soybeanjs/soybean-ui/commit/c6919f129)
  - inline build helpers and drop packages/shared &nbsp;-&nbsp; by @soybeanjs [<samp>(71992)</samp>](https://github.com/soybeanjs/soybean-ui/commit/71992225c)
- **theme**:
  - drop #shared alias and inline shared utils &nbsp;-&nbsp; by @soybeanjs [<samp>(a126a)</samp>](https://github.com/soybeanjs/soybean-ui/commit/a126a372e)
- **tree-nav**:
  - extract TreeNavOverflow and refine selected-state styling &nbsp;-&nbsp; by **soybeanfe** [<samp>(a0ea9)</samp>](https://github.com/soybeanjs/soybean-ui/commit/a0ea9a507)
- **tsconfig**:
  - extend root config instead of redeclaring compiler options &nbsp;-&nbsp; by **soybeanfe** [<samp>(d07ef)</samp>](https://github.com/soybeanjs/soybean-ui/commit/d07ef191b)
- **unocss**:
  - replace unocss-preset-animations with local preset and split by feature &nbsp;-&nbsp; by **soybeanfe** [<samp>(2bcf6)</samp>](https://github.com/soybeanjs/soybean-ui/commit/2bcf6c1aa)

### &nbsp;&nbsp;&nbsp;📖 Documentation

- remove new-docs migration plan and update theme baseline &nbsp;-&nbsp; by **soybeanfe** [<samp>(85032)</samp>](https://github.com/soybeanjs/soybean-ui/commit/85032717d)
- remove obsolete planning docs and refresh ecosystem references &nbsp;-&nbsp; by @soybeanjs [<samp>(5e1f5)</samp>](https://github.com/soybeanjs/soybean-ui/commit/5e1f521c7)
- **avatar**:
  - replace demo image with r2-hosted logo &nbsp;-&nbsp; by **soybeanfe** [<samp>(5b7d0)</samp>](https://github.com/soybeanjs/soybean-ui/commit/5b7d00b26)
- **changelog**:
  - carry v0.30.0 breaking theme note to final release &nbsp;-&nbsp; by **soybeanfe** [<samp>(8fb39)</samp>](https://github.com/soybeanjs/soybean-ui/commit/8fb39c145)
- **components**:
  - sync roving-focus hooks and scripts package references &nbsp;-&nbsp; by @soybeanjs [<samp>(4e054)</samp>](https://github.com/soybeanjs/soybean-ui/commit/4e0545f4f)
- **input-otp**:
  - remove placeholder from basic example &nbsp;-&nbsp; by **soybeanfe** [<samp>(9723b)</samp>](https://github.com/soybeanjs/soybean-ui/commit/9723b1658)
- **migration**:
  - add v0.50.0 rebrand upgrade guide &nbsp;-&nbsp; by **soybeanfe** [<samp>(030cf)</samp>](https://github.com/soybeanjs/soybean-ui/commit/030cf55d1)
- **playground**:
  - remove bottom sheet scale attribute &nbsp;-&nbsp; by **soybeanfe** [<samp>(84dfc)</samp>](https://github.com/soybeanjs/soybean-ui/commit/84dfc5a13)
- **projects**:
  - add changelog api &nbsp;-&nbsp; by **soybeanfe** [<samp>(ad81c)</samp>](https://github.com/soybeanjs/soybean-ui/commit/ad81c636e)
  - update docs &nbsp;-&nbsp; by **soybeanfe** [<samp>(224fd)</samp>](https://github.com/soybeanjs/soybean-ui/commit/224fd8bed)
  - update sbean schema &nbsp;-&nbsp; by **soybeanfe** [<samp>(14951)</samp>](https://github.com/soybeanjs/soybean-ui/commit/149512984)
  - add Nuxt UI theme system research doc &nbsp;-&nbsp; by **soybeanfe** [<samp>(dbb60)</samp>](https://github.com/soybeanjs/soybean-ui/commit/dbb6014a9)
  - update docs api,registry and schema &nbsp;-&nbsp; by @soybeanjs [<samp>(8cf69)</samp>](https://github.com/soybeanjs/soybean-ui/commit/8cf69f106)
  - add ai component roadmap for core headless and ui &nbsp;-&nbsp; by @soybeanjs [<samp>(f7338)</samp>](https://github.com/soybeanjs/soybean-ui/commit/f733850f1)
  - add admin shell roadmap for core headless and ui &nbsp;-&nbsp; by @soybeanjs [<samp>(af22a)</samp>](https://github.com/soybeanjs/soybean-ui/commit/af22a40f2)
- **rebrand**:
  - add VBean rename migration plan &nbsp;-&nbsp; by **soybeanfe** [<samp>(730af)</samp>](https://github.com/soybeanjs/soybean-ui/commit/730afb0d9)
  - align ui-uno target name to @vbean/unocss &nbsp;-&nbsp; by @soybeanjs [<samp>(6d387)</samp>](https://github.com/soybeanjs/soybean-ui/commit/6d3879bc8)
- **sider-menu**:
  - fix route handling and selection logic &nbsp;-&nbsp; by **soybeanfe** [<samp>(aac77)</samp>](https://github.com/soybeanjs/soybean-ui/commit/aac770bf5)
- **skill**:
  - update headless admission criteria and remediation checklist &nbsp;-&nbsp; by **soybeanfe** [<samp>(62f25)</samp>](https://github.com/soybeanjs/soybean-ui/commit/62f25f91e)
  - sync soybean-ui-develop skill with current repo state &nbsp;-&nbsp; by **soybeanfe** [<samp>(27bd8)</samp>](https://github.com/soybeanjs/soybean-ui/commit/27bd872b7)
  - merge audit regression lessons and refresh playground refs &nbsp;-&nbsp; by **soybeanfe** [<samp>(a96f4)</samp>](https://github.com/soybeanjs/soybean-ui/commit/a96f441db)
- **skills**:
  - update skills &nbsp;-&nbsp; by @soybeanjs [<samp>(0a8a0)</samp>](https://github.com/soybeanjs/soybean-ui/commit/0a8a0a682)
  - rename "soybean-ui-component-development" to "soybean-ui-devlop" &nbsp;-&nbsp; by **soybeanfe** [<samp>(1fd7d)</samp>](https://github.com/soybeanjs/soybean-ui/commit/1fd7d726e)
- **theme**:
  - add theme persistence and FOUC strategy doc &nbsp;-&nbsp; by @soybeanjs [<samp>(a7998)</samp>](https://github.com/soybeanjs/soybean-ui/commit/a7998aa71)
- **theme-customizer**:
  - switch popover placement to bottom-start &nbsp;-&nbsp; by **soybeanfe** [<samp>(db819)</samp>](https://github.com/soybeanjs/soybean-ui/commit/db8193d15)
- **v0.50**:
  - add v0.50.0 refactor plan and schedule admission remediation &nbsp;-&nbsp; by **soybeanfe** [<samp>(0fe20)</samp>](https://github.com/soybeanjs/soybean-ui/commit/0fe201100)
- **v0.50.0**:
  - align rename with vbean rebrand and drop removed packages &nbsp;-&nbsp; by @soybeanjs [<samp>(d2587)</samp>](https://github.com/soybeanjs/soybean-ui/commit/d25874804)
  ...
  - add sbean -> cli directory/package rename plan &nbsp;-&nbsp; by @soybeanjs [<samp>(b9acf)</samp>](https://github.com/soybeanjs/soybean-ui/commit/b9acf428b)
- **vbean**:
  - update rebrand-vbean.md &nbsp;-&nbsp; by @soybeanjs [<samp>(a214c)</samp>](https://github.com/soybeanjs/soybean-ui/commit/a214ce72d)
- **zh**:
  - remove orphaned picker pages without demos &nbsp;-&nbsp; by **soybeanfe** [<samp>(a0b4e)</samp>](https://github.com/soybeanjs/soybean-ui/commit/a0b4e25bb)

### &nbsp;&nbsp;&nbsp;📦 Build

- **docs**: use build:libs instead of full build for docs site &nbsp;-&nbsp; by **soybeanfe** [<samp>(303bf)</samp>](https://github.com/soybeanjs/soybean-ui/commit/303bf7ed2)
...
- **deps**:
  - use ts v6 in vue peojects &nbsp;-&nbsp; by @soybeanjs [<samp>(2b5d2)</samp>](https://github.com/soybeanjs/soybean-ui/commit/2b5d24603)
  - update deps &nbsp;-&nbsp; by **soybeanfe** [<samp>(352ba)</samp>](https://github.com/soybeanjs/soybean-ui/commit/352ba9848)
  - track latest vite-plus and pin vitest 5.0.0 &nbsp;-&nbsp; by @soybeanjs [<samp>(2a32a)</samp>](https://github.com/soybeanjs/soybean-ui/commit/2a32a41a6)
  - update deps &nbsp;-&nbsp; by @soybeanjs [<samp>(23221)</samp>](https://github.com/soybeanjs/soybean-ui/commit/232218f9d)
- **docs**:
  - relax CSP to connect-src only &nbsp;-&nbsp; by **soybeanfe** [<samp>(df3fd)</samp>](https://github.com/soybeanjs/soybean-ui/commit/df3fd6ac8)
  - drop deprecated baseUrl and ui source aliases &nbsp;-&nbsp; by @soybeanjs [<samp>(9a062)</samp>](https://github.com/soybeanjs/soybean-ui/commit/9a062053f)
  - load reset/global/ui css via unocss preset flags &nbsp;-&nbsp; by **soybeanfe** [<samp>(48dcb)</samp>](https://github.com/soybeanjs/soybean-ui/commit/48dcb3ae7)
  - upgrade ubean to 0.4.9 &nbsp;-&nbsp; by **soybeanfe** [<samp>(0d1d0)</samp>](https://github.com/soybeanjs/soybean-ui/commit/0d1d024f2)
...
- **packages**:
  - expose src entries for ui and ui-x in dev exports &nbsp;-&nbsp; by **soybeanfe** [<samp>(3bda8)</samp>](https://github.com/soybeanjs/soybean-ui/commit/3bda89276)
  - declare sideEffects to enable tree-shaking &nbsp;-&nbsp; by **soybeanfe** [<samp>(0c494)</samp>](https://github.com/soybeanjs/soybean-ui/commit/0c4948717)
- **projects**:
  - bump cva/oxc-config and switch typescript to ts6 catalog &nbsp;-&nbsp; by @soybeanjs [<samp>(4a275)</samp>](https://github.com/soybeanjs/soybean-ui/commit/4a2753d16)
  - update api docs and schema &nbsp;-&nbsp; by **soybeanfe** [<samp>(fd792)</samp>](https://github.com/soybeanjs/soybean-ui/commit/fd79247dc)
  - optimize packageManage &nbsp;-&nbsp; by **soybeanfe** [<samp>(1d435)</samp>](https://github.com/soybeanjs/soybean-ui/commit/1d435b7a7)
  - update ts version and update deps &nbsp;-&nbsp; by **soybeanfe** [<samp>(fe08d)</samp>](https://github.com/soybeanjs/soybean-ui/commit/fe08dac3e)
- **scripts**:
  - add preview script to package.json &nbsp;-&nbsp; by @soybeanjs [<samp>(6197b)</samp>](https://github.com/soybeanjs/soybean-ui/commit/6197b9ff0)
- **tools**:
  - add vbean rename codemod scripts &nbsp;-&nbsp; by **soybeanfe** [<samp>(479b9)</samp>](https://github.com/soybeanjs/soybean-ui/commit/479b9ccf7)

### &nbsp;&nbsp;&nbsp;✅ Tests

- **sbean**: align registry expansion expectation with inject-key migration &nbsp;-&nbsp; by @soybeanjs [<samp>(f6af0)</samp>](https://github.com/soybeanjs/soybean-ui/commit/f6af0c5ba)
...
- **docs**:
  - apply lint autofix to example components &nbsp;-&nbsp; by **soybeanfe** [<samp>(2d263)</samp>](https://github.com/soybeanjs/soybean-ui/commit/2d2638e55)
  - add bottom border to header when not scrolled &nbsp;-&nbsp; by **soybeanfe** [<samp>(85bf4)</samp>](https://github.com/soybeanjs/soybean-ui/commit/85bf41dc6)
- **form**:
  - update control class for horizontal orientation &nbsp;-&nbsp; by @soybeanjs [<samp>(9d536)</samp>](https://github.com/soybeanjs/soybean-ui/commit/9d536bdc3)
- **logo**:
  - optimize app-logo style &nbsp;-&nbsp; by **soybeanfe** [<samp>(ae8a0)</samp>](https://github.com/soybeanjs/soybean-ui/commit/ae8a0a30d)
- **playground**:
  - remove unused enable-indicator prop of STabs &nbsp;-&nbsp; by **soybeanfe** [<samp>(a30be)</samp>](https://github.com/soybeanjs/soybean-ui/commit/a30be03d0)
- **projects**:
  - update type order &nbsp;-&nbsp; by **soybeanfe** [<samp>(66a19)</samp>](https://github.com/soybeanjs/soybean-ui/commit/66a193db8)
- **releases page**:
  - add justify-start to upgrade guide button classes &nbsp;-&nbsp; by **soybeanfe** [<samp>(84b8a)</samp>](https://github.com/soybeanjs/soybean-ui/commit/84b8ae60f)
...
- **TreeNav**:
  - split headless primitives, align items type with TreeMenu and flatten root context &nbsp;-&nbsp; by @soybeanjs [<samp>(980a3)</samp>](https://github.com/soybeanjs/soybean-ui/commit/980a366ab)
- **cascader**:
  - improve search input, keyboard select closing, and panel spacing &nbsp;-&nbsp; by @soybeanjs [<samp>(3c6a9)</samp>](https://github.com/soybeanjs/soybean-ui/commit/3c6a947d5)
- **color-picker**:
  - optimize style &nbsp;-&nbsp; by @soybeanjs [<samp>(3e187)</samp>](https://github.com/soybeanjs/soybean-ui/commit/3e187b8ea)
- **combobox**:
  - move clear action to trigger and add ComboboxValue primitive &nbsp;-&nbsp; by @soybeanjs [<samp>(8fea1)</samp>](https://github.com/soybeanjs/soybean-ui/commit/8fea1fc14)
- **components**:
  - optimize clipboard examples, add onlyIcon prop &nbsp;-&nbsp; by @soybeanjs [<samp>(66435)</samp>](https://github.com/soybeanjs/soybean-ui/commit/664357bad)
- **playground**:
  - remove useless ThemeGenerator &nbsp;-&nbsp; by @soybeanjs [<samp>(090e5)</samp>](https://github.com/soybeanjs/soybean-ui/commit/090e5a011)
- **projects**:
  - optimize deps and build config &nbsp;-&nbsp; by **soybeanfe** [<samp>(8d981)</samp>](https://github.com/soybeanjs/soybean-ui/commit/8d981e758)
  - optimize build config &nbsp;-&nbsp; by **soybeanfe** [<samp>(e4606)</samp>](https://github.com/soybeanjs/soybean-ui/commit/e46064391)
- **select**:
  - make clearable prop default value to false &nbsp;-&nbsp; by @soybeanjs [<samp>(a6d4d)</samp>](https://github.com/soybeanjs/soybean-ui/commit/a6d4ddba9)
- **shared**:
  - optimize kebabCase &nbsp;-&nbsp; by **soybeanfe** [<samp>(aec51)</samp>](https://github.com/soybeanjs/soybean-ui/commit/aec51770c)
- **styles**:
  - optimize components styles &nbsp;-&nbsp; by **soybeanfe** [<samp>(52ca7)</samp>](https://github.com/soybeanjs/soybean-ui/commit/52ca72f49)
- **table**:
  - update rounded prop to false in table styles and components &nbsp;-&nbsp; by **soybeanfe** [<samp>(6c496)</samp>](https://github.com/soybeanjs/soybean-ui/commit/6c4969622)
- **tree-menu**:
  - add pxToRem default value &nbsp;-&nbsp; by @soybeanjs [<samp>(abcf5)</samp>](https://github.com/soybeanjs/soybean-ui/commit/abcf585cf)
...
- **deps**:
  ...
  - track latest vite-plus and pin vitest 5.0.0 &nbsp;-&nbsp; by @soybeanjs [<samp>(2a32a)</samp>](https://github.com/soybeanjs/soybean-ui/commit/2a32a41a6)
- **docs**:
  - regenerate API locales for wrapped overlay primitives &nbsp;-&nbsp; by **soybeanfe** and @cursoragent [<samp>(fa880)</samp>](https://github.com/soybeanjs/soybean-ui/commit/fa880ff6d)
  - relax CSP to connect-src only &nbsp;-&nbsp; by **soybeanfe** [<samp>(df3fd)</samp>](https://github.com/soybeanjs/soybean-ui/commit/df3fd6ac8)
  - drop deprecated baseUrl and ui source aliases &nbsp;-&nbsp; by @soybeanjs [<samp>(9a062)</samp>](https://github.com/soybeanjs/soybean-ui/commit/9a062053f)
  - load reset/global/ui css via unocss preset flags &nbsp;-&nbsp; by **soybeanfe** [<samp>(48dcb)</samp>](https://github.com/soybeanjs/soybean-ui/commit/48dcb3ae7)
  - upgrade ubean to 0.4.9 &nbsp;-&nbsp; by **soybeanfe** [<samp>(0d1d0)</samp>](https://github.com/soybeanjs/soybean-ui/commit/0d1d024f2)
...
- **ColorSwatchPicker**:
  - fix checked style &nbsp;-&nbsp; by @soybeanjs [<samp>(5c0fd)</samp>](https://github.com/soybeanjs/soybean-ui/commit/5c0fd832b)
- **components**:
  - optimize components styles &nbsp;-&nbsp; by @soybeanjs [<samp>(50ffd)</samp>](https://github.com/soybeanjs/soybean-ui/commit/50ffd0d64)
- **docs**:
  - apply lint autofix to example components &nbsp;-&nbsp; by **soybeanfe** [<samp>(2d263)</samp>](https://github.com/soybeanjs/soybean-ui/commit/2d2638e55)
  - add bottom border to header when not scrolled &nbsp;-&nbsp; by **soybeanfe** [<samp>(85bf4)</samp>](https://github.com/soybeanjs/soybean-ui/commit/85bf41dc6)
- **logo**:
  - optimize app-logo style &nbsp;-&nbsp; by **soybeanfe** [<samp>(ae8a0)</samp>](https://github.com/soybeanjs/soybean-ui/commit/ae8a0a30d)
- **menu**:
  - optimize menu space &nbsp;-&nbsp; by @soybeanjs [<samp>(5c0a5)</samp>](https://github.com/soybeanjs/soybean-ui/commit/5c0a57be4)
- **projects**:
  - format code &nbsp;-&nbsp; by @soybeanjs [<samp>(5742e)</samp>](https://github.com/soybeanjs/soybean-ui/commit/5742ea77b)
  - update type order &nbsp;-&nbsp; by **soybeanfe** [<samp>(66a19)</samp>](https://github.com/soybeanjs/soybean-ui/commit/66a193db8)
...
- **components**:
  - Implement Cascader &nbsp;-&nbsp; by @soybeanjs [<samp>(4ad33)</samp>](https://github.com/soybeanjs/soybean-ui/commit/4ad33806)
  - Implement rating component &nbsp;-&nbsp; by @soybeanjs [<samp>(d8255)</samp>](https://github.com/soybeanjs/soybean-ui/commit/d82555d0)
  - Implement PalettePicker components &nbsp;-&nbsp; by @soybeanjs [<samp>(096be)</samp>](https://github.com/soybeanjs/soybean-ui/commit/096be161)
  - Select support top and bottom slots &nbsp;-&nbsp; by @soybeanjs [<samp>(cae7a)</samp>](https://github.com/soybeanjs/soybean-ui/commit/cae7ad4b)
  - TreeVirtualizer support animated expand &nbsp;-&nbsp; by @soybeanjs [<samp>(5b920)</samp>](https://github.com/soybeanjs/soybean-ui/commit/5b9205a2)
- **dialog**:
  - add fullscreen and draggable features &nbsp;-&nbsp; by @soybeanjs [<samp>(fac2c)</samp>](https://github.com/soybeanjs/soybean-ui/commit/fac2c421)
- **icon**:
  - optimize icon props &nbsp;-&nbsp; by **soybeanfe** [<samp>(206c5)</samp>](https://github.com/soybeanjs/soybean-ui/commit/206c56b4)
- **menubar**:
  - support hover trigger and show ellipsis item when overflow &nbsp;-&nbsp; by @soybeanjs [<samp>(5924e)</samp>](https://github.com/soybeanjs/soybean-ui/commit/5924e61f)
- **packages**:
  - add theme presets packages &nbsp;-&nbsp; by @soybeanjs [<samp>(da1db)</samp>](https://github.com/soybeanjs/soybean-ui/commit/da1dbc31)
  - add ui-x &nbsp;-&nbsp; by @soybeanjs [<samp>(2c39d)</samp>](https://github.com/soybeanjs/soybean-ui/commit/2c39d5e0)
  - update charts components &nbsp;-&nbsp; by @soybeanjs [<samp>(e0d9c)</samp>](https://github.com/soybeanjs/soybean-ui/commit/e0d9cc6e)
- **page-tabs**:
  - support drag &nbsp;-&nbsp; by **soybeanfe** [<samp>(61d24)</samp>](https://github.com/soybeanjs/soybean-ui/commit/61d24668)
- **playground**:
  - add theme generator component and register it &nbsp;-&nbsp; by @soybeanjs [<samp>(6678d)</samp>](https://github.com/soybeanjs/soybean-ui/commit/6678dd68)
- **projects**:
  - add ecosystem: ui-x,admin,chart and refactor project structure &nbsp;-&nbsp; by @soybeanjs [<samp>(d4826)</samp>](https://github.com/soybeanjs/soybean-ui/commit/d482677d)
- **sbean**:
  - adopt shadcn-vue parity ADRs 002/005/006/008/009 &nbsp;-&nbsp; by @soybeanjs [<samp>(d0eaf)</samp>](https://github.com/soybeanjs/soybean-ui/commit/d0eafdc7)
  - Complete multi-package registry and CLI namespace support &nbsp;-&nbsp; by @soybeanjs [<samp>(4c9e1)</samp>](https://github.com/soybeanjs/soybean-ui/commit/4c9e13a2)
- **theme**:
  - add theme package &nbsp;-&nbsp; by @soybeanjs [<samp>(72630)</samp>](https://github.com/soybeanjs/soybean-ui/commit/72630059)
  - add complete preset optimization option &nbsp;-&nbsp; by @soybeanjs [<samp>(e3d61)</samp>](https://github.com/soybeanjs/soybean-ui/commit/e3d61638)
  - add ui-unocss preset package over the theme engine &nbsp;-&nbsp; by **soybeanfe** [<samp>(28b90)</samp>](https://github.com/soybeanjs/soybean-ui/commit/28b901fa)
- **tree-menu**:
  - add expandStrategy prop, support keep and active mode &nbsp;-&nbsp; by @soybeanjs [<samp>(5d911)</samp>](https://github.com/soybeanjs/soybean-ui/commit/5d91103e)
- **ui-unocss**:
  - fully cover SbeanUnoConfig in the preset bridge &nbsp;-&nbsp; by **soybeanfe** [<samp>(02036)</samp>](https://github.com/soybeanjs/soybean-ui/commit/02036bbe)

### &nbsp;&nbsp;&nbsp;🐞 Bug Fixes

- **cascader**:
  - Corrected the highlighting logic and style of the parent node in the cascading selector. &nbsp;-&nbsp; by @soybeanjs [<samp>(73f50)</samp>](https://github.com/soybeanjs/soybean-ui/commit/73f50b92)
- **components**:
  - fix the issue of residual styles in popup pointer events &nbsp;-&nbsp; by @soybeanjs [<samp>(ef304)</samp>](https://github.com/soybeanjs/soybean-ui/commit/ef304eff)
- **config-provider**:
  - fix toggle dark mode &nbsp;-&nbsp; by **soybeanfe** [<samp>(8c608)</samp>](https://github.com/soybeanjs/soybean-ui/commit/8c608d19)
- **deps**:
  - remove TypeScript error for fontsource-variable and update brace-expansion to 5.0.8 &nbsp;-&nbsp; by **soybeanfe** [<samp>(b0f93)</samp>](https://github.com/soybeanjs/soybean-ui/commit/b0f93fb2)
- **e2e**:
  - align browser e2e baseline with vitest 4 &nbsp;-&nbsp; by @soybeanjs [<samp>(351fd)</samp>](https://github.com/soybeanjs/soybean-ui/commit/351fde40)
- **form-input**:
  - harden segment/date-field/date-picker &nbsp;-&nbsp; by **soybeanfe** [<samp>(efe56)</samp>](https://github.com/soybeanjs/soybean-ui/commit/efe56c52)
- **hooks**:
  - fix dismissable layer stack order &nbsp;-&nbsp; by @soybeanjs [<samp>(a9fa2)</samp>](https://github.com/soybeanjs/soybean-ui/commit/a9fa2466)
  - force presence unmount when exit animation name stops resolving &nbsp;-&nbsp; by @soybeanjs [<samp>(ff2c7)</samp>](https://github.com/soybeanjs/soybean-ui/commit/ff2c7076)
- **icon**:
  - fix aria-hidden, aria-label, shrink-0 and data-soybean-icon attributes &nbsp;-&nbsp; by @soybeanjs [<samp>(cf042)</samp>](https://github.com/soybeanjs/soybean-ui/commit/cf042323)
- **menubar**:
  - prevent trigger clicks from dismissing open menus &nbsp;-&nbsp; by @soybeanjs [<samp>(574b5)</samp>](https://github.com/soybeanjs/soybean-ui/commit/574b5053)
- **popup**:
  - add focus event for popup components &nbsp;-&nbsp; by @soybeanjs [<samp>(e42d5)</samp>](https://github.com/soybeanjs/soybean-ui/commit/e42d5df5)
- **projects**:
  - fix docs build &nbsp;-&nbsp; by **soybeanfe** [<samp>(fb4cc)</samp>](https://github.com/soybeanjs/soybean-ui/commit/fb4cce48)
  - fix playground build script &nbsp;-&nbsp; by **soybeanfe** [<samp>(cb0e5)</samp>](https://github.com/soybeanjs/soybean-ui/commit/cb0e5421)
- **scripts**:
  - update build:docs script to ensure proper execution order &nbsp;-&nbsp; by **soybeanfe** [<samp>(6e5bf)</samp>](https://github.com/soybeanjs/soybean-ui/commit/6e5bf809)
- **select**:
  - fix scroll in large list &nbsp;-&nbsp; by @soybeanjs [<samp>(ff970)</samp>](https://github.com/soybeanjs/soybean-ui/commit/ff9703a4)
- **types**:
  - fix type error &nbsp;-&nbsp; by @soybeanjs [<samp>(61ba2)</samp>](https://github.com/soybeanjs/soybean-ui/commit/61ba26d6)

### &nbsp;&nbsp;&nbsp;🛠 Optimizations

- **cascader**:
  - optimize style and fix multiple logic &nbsp;-&nbsp; by **soybeanfe** [<samp>(7e1dc)</samp>](https://github.com/soybeanjs/soybean-ui/commit/7e1dcff0)
- **components**:
  - optimize clipboard &nbsp;-&nbsp; by **soybeanfe** [<samp>(d1b9c)</samp>](https://github.com/soybeanjs/soybean-ui/commit/d1b9c88b)
  - optimize ThemeGenerator &nbsp;-&nbsp; by **soybeanfe** [<samp>(596bf)</samp>](https://github.com/soybeanjs/soybean-ui/commit/596bfd2c)
  - optimize ThemeGenerator &nbsp;-&nbsp; by @soybeanjs [<samp>(c19d3)</samp>](https://github.com/soybeanjs/soybean-ui/commit/c19d383c)
  - optimize ThemeCustomizer &nbsp;-&nbsp; by @soybeanjs [<samp>(85a8a)</samp>](https://github.com/soybeanjs/soybean-ui/commit/85a8abde)
  - optimize PalettePicker &nbsp;-&nbsp; by @soybeanjs [<samp>(ffafc)</samp>](https://github.com/soybeanjs/soybean-ui/commit/ffafcc62)
  - remove preset manage in ThemeCustomizer &nbsp;-&nbsp; by @soybeanjs [<samp>(a8a5f)</samp>](https://github.com/soybeanjs/soybean-ui/commit/a8a5f857)
  - optimize color-swatch-picker styles &nbsp;-&nbsp; by @soybeanjs [<samp>(aa483)</samp>](https://github.com/soybeanjs/soybean-ui/commit/aa4834d4)
  - optimize layout style &nbsp;-&nbsp; by @soybeanjs [<samp>(8915c)</samp>](https://github.com/soybeanjs/soybean-ui/commit/8915ccfd)
  - Unify link attribute processing logic and separate global and item-level configurations. &nbsp;-&nbsp; by @soybeanjs [<samp>(3505c)</samp>](https://github.com/soybeanjs/soybean-ui/commit/3505cf80)
- **docs**:
  - add sbean official dev guide and clean up old guide &nbsp;-&nbsp; by @soybeanjs [<samp>(160a5)</samp>](https://github.com/soybeanjs/soybean-ui/commit/160a5e18)
- **headless**:
  - optimize headless components &nbsp;-&nbsp; by @soybeanjs [<samp>(0f8bb)</samp>](https://github.com/soybeanjs/soybean-ui/commit/0f8bbf28)
- **menu**:
  - add default prioritizePosition prop &nbsp;-&nbsp; by @soybeanjs [<samp>(0b47e)</samp>](https://github.com/soybeanjs/soybean-ui/commit/0b47ef71)
  - add default prioritizePosition prop &nbsp;-&nbsp; by @soybeanjs [<samp>(45fed)</samp>](https://github.com/soybeanjs/soybean-ui/commit/45feda5c)
- **projects**:
  - optimzie check components code &nbsp;-&nbsp; by **soybeanfe** [<samp>(c0989)</samp>](https://github.com/soybeanjs/soybean-ui/commit/c0989811)
  - optimize check components code &nbsp;-&nbsp; by @soybeanjs [<samp>(08b56)</samp>](https://github.com/soybeanjs/soybean-ui/commit/08b56374)
  - optimize theme preset &nbsp;-&nbsp; by **soybeanfe** [<samp>(60513)</samp>](https://github.com/soybeanjs/soybean-ui/commit/60513fc5)
  - optimize theme types &nbsp;-&nbsp; by **soybeanfe** [<samp>(6f6a0)</samp>](https://github.com/soybeanjs/soybean-ui/commit/6f6a074a)
  - clean check components docs &nbsp;-&nbsp; by **soybeanfe** [<samp>(6b433)</samp>](https://github.com/soybeanjs/soybean-ui/commit/6b4334f1)
- **sbean**:
  - optimize sbean &nbsp;-&nbsp; by @soybeanjs [<samp>(5d001)</samp>](https://github.com/soybeanjs/soybean-ui/commit/5d001ae5)

### &nbsp;&nbsp;&nbsp;💅 Refactors

- **components**:
  - refactor ThemeCustomizer &nbsp;-&nbsp; by @soybeanjs [<samp>(dc84b)</samp>](https://github.com/soybeanjs/soybean-ui/commit/dc84b130)
  - refactor layout &nbsp;-&nbsp; by @soybeanjs [<samp>(b2d5a)</samp>](https://github.com/soybeanjs/soybean-ui/commit/b2d5a03e)
- **packages**:
  - remove theme presets packages &nbsp;-&nbsp; by @soybeanjs [<samp>(84fd2)</samp>](https://github.com/soybeanjs/soybean-ui/commit/84fd2c7a)
  - refactor theme &nbsp;-&nbsp; by **soybeanfe** [<samp>(39e7c)</samp>](https://github.com/soybeanjs/soybean-ui/commit/39e7c481)
  - rename "packages/ui-unocss" to "packages/unocss" &nbsp;-&nbsp; by **soybeanfe** [<samp>(8df6c)</samp>](https://github.com/soybeanjs/soybean-ui/commit/8df6c0bd)
- **projects**:
  - refactor theme &nbsp;-&nbsp; by @soybeanjs [<samp>(f582a)</samp>](https://github.com/soybeanjs/soybean-ui/commit/f582a032)
  - refactor ui-x docs generated &nbsp;-&nbsp; by @soybeanjs [<samp>(db867)</samp>](https://github.com/soybeanjs/soybean-ui/commit/db867c80)
- **theme**:
  - consolidate theme packages and drop feedback dimension &nbsp;-&nbsp; by **soybeanfe** [<samp>(b7297)</samp>](https://github.com/soybeanjs/soybean-ui/commit/b729728d)
  - refactor theme system &nbsp;-&nbsp; by @soybeanjs [<samp>(65caa)</samp>](https://github.com/soybeanjs/soybean-ui/commit/65caaa9c)
  - remove cookie storage &nbsp;-&nbsp; by @soybeanjs [<samp>(e4511)</samp>](https://github.com/soybeanjs/soybean-ui/commit/e4511691)
  - remove menu related css tokens and update api generate config &nbsp;-&nbsp; by @soybeanjs [<samp>(c9fef)</samp>](https://github.com/soybeanjs/soybean-ui/commit/c9fefa84)
- **theme-generator**:
  - split code &nbsp;-&nbsp; by @soybeanjs [<samp>(84d9b)</samp>](https://github.com/soybeanjs/soybean-ui/commit/84d9b8d0)

### &nbsp;&nbsp;&nbsp;📖 Documentation

- **AGENTS**:
  - optimize AGENTS &nbsp;-&nbsp; by @soybeanjs [<samp>(34fbc)</samp>](https://github.com/soybeanjs/soybean-ui/commit/34fbc572)
- **agents**:
  - add domain and issue tracker agent docs &nbsp;-&nbsp; by @soybeanjs [<samp>(5e3dc)</samp>](https://github.com/soybeanjs/soybean-ui/commit/5e3dcf9d)
- **api**:
  - update docs api &nbsp;-&nbsp; by @soybeanjs [<samp>(0a60c)</samp>](https://github.com/soybeanjs/soybean-ui/commit/0a60c023)
- **check**:
  - record batch 1 component check execution records &nbsp;-&nbsp; by @soybeanjs [<samp>(e6d6c)</samp>](https://github.com/soybeanjs/soybean-ui/commit/e6d6cc66)
- **components**:
  - align 10 component docs with recommended structure &nbsp;-&nbsp; by @soybeanjs [<samp>(889aa)</samp>](https://github.com/soybeanjs/soybean-ui/commit/889aae64)
- **menubar**:
  - mark dialog/select e2e baseline fix as verified &nbsp;-&nbsp; by @soybeanjs [<samp>(96d00)</samp>](https://github.com/soybeanjs/soybean-ui/commit/96d005a6)
  - update menubar docs api and skills &nbsp;-&nbsp; by @soybeanjs [<samp>(de78c)</samp>](https://github.com/soybeanjs/soybean-ui/commit/de78c41f)
- **projects**:
  - add roadmap.md &nbsp;-&nbsp; by @soybeanjs [<samp>(67397)</samp>](https://github.com/soybeanjs/soybean-ui/commit/6739783f)
  - update component audit check docs &nbsp;-&nbsp; by @soybeanjs [<samp>(58653)</samp>](https://github.com/soybeanjs/soybean-ui/commit/586531dc)
  - update docs &nbsp;-&nbsp; by @soybeanjs [<samp>(b3233)</samp>](https://github.com/soybeanjs/soybean-ui/commit/b3233952)
  - update architecture and audit references to reflect 102 check items &nbsp;-&nbsp; by **soybeanfe** [<samp>(bc25b)</samp>](https://github.com/soybeanjs/soybean-ui/commit/bc25b9f9)
  - update api docs jsons &nbsp;-&nbsp; by @soybeanjs [<samp>(511bc)</samp>](https://github.com/soybeanjs/soybean-ui/commit/511bc1ab)
  - update docs and api and skills &nbsp;-&nbsp; by **soybeanfe** [<samp>(c96c7)</samp>](https://github.com/soybeanjs/soybean-ui/commit/c96c7dff)
  - add ecosystem and task tracking documents &nbsp;-&nbsp; by **soybeanfe** [<samp>(b1093)</samp>](https://github.com/soybeanjs/soybean-ui/commit/b1093306)
  - optimzie docs structure &nbsp;-&nbsp; by **soybeanfe** [<samp>(0f9d9)</samp>](https://github.com/soybeanjs/soybean-ui/commit/0f9d9d30)
  - update logo link &nbsp;-&nbsp; by **soybeanfe** [<samp>(c11b3)</samp>](https://github.com/soybeanjs/soybean-ui/commit/c11b3b36)
  - fix skills generated &nbsp;-&nbsp; by @soybeanjs [<samp>(8bf7e)</samp>](https://github.com/soybeanjs/soybean-ui/commit/8bf7e9b4)
  - update docs api and skills &nbsp;-&nbsp; by @soybeanjs [<samp>(27e7d)</samp>](https://github.com/soybeanjs/soybean-ui/commit/27e7dc4b)
  - add tip for ui-x,chart,admin &nbsp;-&nbsp; by **soybeanfe** [<samp>(b0db5)</samp>](https://github.com/soybeanjs/soybean-ui/commit/b0db53d8)
  - update docs api and skills &nbsp;-&nbsp; by @soybeanjs [<samp>(b7ea0)</samp>](https://github.com/soybeanjs/soybean-ui/commit/b7ea01c3)
  - update docs api and skills &nbsp;-&nbsp; by @soybeanjs [<samp>(6371e)</samp>](https://github.com/soybeanjs/soybean-ui/commit/6371e07a)
  - update logo URLs in README files &nbsp;-&nbsp; by **soybeanfe** [<samp>(1ae01)</samp>](https://github.com/soybeanjs/soybean-ui/commit/1ae01c20)
  - update docs and changelog &nbsp;-&nbsp; by **soybeanfe** [<samp>(d4828)</samp>](https://github.com/soybeanjs/soybean-ui/commit/d48282ef)
- **skill**:
  - update skill docs &nbsp;-&nbsp; by **soybeanfe** [<samp>(d6e7b)</samp>](https://github.com/soybeanjs/soybean-ui/commit/d6e7b66e)
- **skills**:
  - refactor skills docs &nbsp;-&nbsp; by @soybeanjs [<samp>(17ba1)</samp>](https://github.com/soybeanjs/soybean-ui/commit/17ba1852)
- **theme**:
  - add theme system design docs for new theme system docs: &nbsp;-&nbsp; by @soybeanjs [<samp>(d2ada)</samp>](https://github.com/soybeanjs/soybean-ui/commit/d2ada580)
  - clean docs about theme &nbsp;-&nbsp; by @soybeanjs [<samp>(7943b)</samp>](https://github.com/soybeanjs/soybean-ui/commit/7943bc0e)

### &nbsp;&nbsp;&nbsp;🏡 Chore

- **.vscode**:
  - add oxc formatter config path &nbsp;-&nbsp; by **soybeanfe** [<samp>(ca08e)</samp>](https://github.com/soybeanjs/soybean-ui/commit/ca08e4b8)
- **deps**:
  - update deps &nbsp;-&nbsp; by @soybeanjs [<samp>(96a66)</samp>](https://github.com/soybeanjs/soybean-ui/commit/96a66f1f)
  - update deps &nbsp;-&nbsp; by **soybeanfe** [<samp>(a3128)</samp>](https://github.com/soybeanjs/soybean-ui/commit/a31288de)
  - update deps &nbsp;-&nbsp; by @soybeanjs [<samp>(262ba)</samp>](https://github.com/soybeanjs/soybean-ui/commit/262ba768)
  - update deps &nbsp;-&nbsp; by @soybeanjs [<samp>(9d958)</samp>](https://github.com/soybeanjs/soybean-ui/commit/9d958920)
  - update deps &nbsp;-&nbsp; by **soybeanfe** [<samp>(081f1)</samp>](https://github.com/soybeanjs/soybean-ui/commit/081f1450)
  - update deps &nbsp;-&nbsp; by @soybeanjs [<samp>(f5509)</samp>](https://github.com/soybeanjs/soybean-ui/commit/f5509efe)
  - update deps &nbsp;-&nbsp; by @soybeanjs [<samp>(56e3f)</samp>](https://github.com/soybeanjs/soybean-ui/commit/56e3f4e1)
  - update deps &nbsp;-&nbsp; by @soybeanjs [<samp>(240c9)</samp>](https://github.com/soybeanjs/soybean-ui/commit/240c9eae)
  - update deps &nbsp;-&nbsp; by **soybeanfe** [<samp>(9fc1f)</samp>](https://github.com/soybeanjs/soybean-ui/commit/9fc1f7f1)
- **projects**:
  - optimize ci config and packages scripts &nbsp;-&nbsp; by @soybeanjs [<samp>(82ffb)</samp>](https://github.com/soybeanjs/soybean-ui/commit/82ffbc00)
  - update renamed "@soybeanjs/ui-uno" docs &nbsp;-&nbsp; by **soybeanfe** [<samp>(8d8eb)</samp>](https://github.com/soybeanjs/soybean-ui/commit/8d8ebe4b)
- **uno**:
  - add and update unocss config &nbsp;-&nbsp; by @soybeanjs [<samp>(4ac02)</samp>](https://github.com/soybeanjs/soybean-ui/commit/4ac02804)

### &nbsp;&nbsp;&nbsp;✅ Tests

- **projects**: add test spec for chart and admin packages &nbsp;-&nbsp; by @soybeanjs [<samp>(19a8c)</samp>](https://github.com/soybeanjs/soybean-ui/commit/19a8c142)

### &nbsp;&nbsp;&nbsp;🎨 Styles

- **calendar-range**:
  - fix highlighted style &nbsp;-&nbsp; by **soybeanfe** [<samp>(37b50)</samp>](https://github.com/soybeanjs/soybean-ui/commit/37b50838)
- **packages**:
  - optimzie layout css writing &nbsp;-&nbsp; by **soybeanfe** [<samp>(4f0f0)</samp>](https://github.com/soybeanjs/soybean-ui/commit/4f0f09ee)
- **projects**:
  - format code &nbsp;-&nbsp; by @soybeanjs [<samp>(6d486)</samp>](https://github.com/soybeanjs/soybean-ui/commit/6d486ed6)
  - format code &nbsp;-&nbsp; by @soybeanjs [<samp>(df8d4)</samp>](https://github.com/soybeanjs/soybean-ui/commit/df8d437a)
- **stepper**:
  - optimize style &nbsp;-&nbsp; by **soybeanfe** [<samp>(0223b)</samp>](https://github.com/soybeanjs/soybean-ui/commit/0223b6d6)
- **theme-customizer**:
  - change width to 100 &nbsp;-&nbsp; by @soybeanjs [<samp>(7a3a7)</samp>](https://github.com/soybeanjs/soybean-ui/commit/7a3a758e)
- **toggle-group**:
  - fix demo class &nbsp;-&nbsp; by @soybeanjs [<samp>(e27e0)</samp>](https://github.com/soybeanjs/soybean-ui/commit/e27e09a4)
- **ui-unocss**:
  - add root font size and 2xl radius config &nbsp;-&nbsp; by @soybeanjs [<samp>(72442)</samp>](https://github.com/soybeanjs/soybean-ui/commit/724424a9)
- **ui/toolbar**:
  - add vertical style items-stretch &nbsp;-&nbsp; by @soybeanjs [<samp>(4c239)</samp>](https://github.com/soybeanjs/soybean-ui/commit/4c2395c9)

### &nbsp;&nbsp;&nbsp;🤖 CI

- **projects**: update ci config &nbsp;-&nbsp; by **soybeanfe** [<samp>(e7f88)</samp>](https://github.com/soybeanjs/soybean-ui/commit/e7f8888a)
...
- **config-provider**:
  - import updateUiAttribute from shadcn-theme &nbsp;-&nbsp; by @soybeanjs [<samp>(6679f)</samp>](https://github.com/soybeanjs/soybean-ui/commit/6679f3375)
- **docs**:
  ...
  - add installation and CLI documentation in English and Chinese &nbsp;-&nbsp; by **soybeanfe** [<samp>(8e1d2)</samp>](https://github.com/soybeanjs/soybean-ui/commit/8e1d29e0b)
  - enhance introduction and quick start guides with two distribution modes &nbsp;-&nbsp; by **soybeanfe** [<samp>(66f60)</samp>](https://github.com/soybeanjs/soybean-ui/commit/66f60dab2)
- **packages**:
...
- **registry**:
  - update sbean registry &nbsp;-&nbsp; by @soybeanjs [<samp>(ca250)</samp>](https://github.com/soybeanjs/soybean-ui/commit/ca2509aa1)
  - update sbean registry &nbsp;-&nbsp; by @soybeanjs [<samp>(fb31b)</samp>](https://github.com/soybeanjs/soybean-ui/commit/fb31bdffe)
- **sbean**:
  - add sbean CLI tool for component copy-paste &nbsp;-&nbsp; by **soybeanfe** [<samp>(faeb1)</samp>](https://github.com/soybeanjs/soybean-ui/commit/faeb1b1c2)
  - add registry fetching capabilities and enhance configuration &nbsp;-&nbsp; by **soybeanfe** [<samp>(06c40)</samp>](https://github.com/soybeanjs/soybean-ui/commit/06c40eb26)
  - add current todo list for shadcn parity &nbsp;-&nbsp; by **soybeanfe** [<samp>(dd11b)</samp>](https://github.com/soybeanjs/soybean-ui/commit/dd11bbe1d)
  ...
  - add Nuxt 3 project initialization support &nbsp;-&nbsp; by @soybeanjs [<samp>(5ac6c)</samp>](https://github.com/soybeanjs/soybean-ui/commit/5ac6c6d66)
- **template**:
  - add version syncing script and update dependencies &nbsp;-&nbsp; by **soybeanfe** [<samp>(406d2)</samp>](https://github.com/soybeanjs/soybean-ui/commit/406d21410)
- **theme**:
...
- **build**:
  - add sbean build script to the build process &nbsp;-&nbsp; by **soybeanfe** [<samp>(7864f)</samp>](https://github.com/soybeanjs/soybean-ui/commit/7864f410f)
- **config-provider**:
  - clean up imports and remove unused default preset options check &nbsp;-&nbsp; by **soybeanfe** [<samp>(2b18c)</samp>](https://github.com/soybeanjs/soybean-ui/commit/2b18c5ec7)
- **css**:
  - handle fallback for radius value in generateRadiusCSSVariable &nbsp;-&nbsp; by **soybeanfe** [<samp>(e723a)</samp>](https://github.com/soybeanjs/soybean-ui/commit/e723a75d1)
  - update generateSizeCss to accept styleTarget and size parameters &nbsp;-&nbsp; by @soybeanjs [<samp>(5ac32)</samp>](https://github.com/soybeanjs/soybean-ui/commit/5ac3260b9)
- **deps**:
  - update markdown-exit to version 1.1.0-beta.2 &nbsp;-&nbsp; by @soybeanjs [<samp>(b7603)</samp>](https://github.com/soybeanjs/soybean-ui/commit/b76038612)
- **docs**:
  - update installation instructions and links for skills &nbsp;-&nbsp; by **soybeanfe** [<samp>(a5e1f)</samp>](https://github.com/soybeanjs/soybean-ui/commit/a5e1fb7d8)
- **icon**:
  - correct import path for useConfigProvider &nbsp;-&nbsp; by @soybeanjs [<samp>(7ad9c)</samp>](https://github.com/soybeanjs/soybean-ui/commit/7ad9ca875)
- **init**:
  - correct JSON syntax in TypeScript configuration generation &nbsp;-&nbsp; by **soybeanfe** [<samp>(68994)</samp>](https://github.com/soybeanjs/soybean-ui/commit/689945196)
- **sbean**:
  - correct build script for headless component &nbsp;-&nbsp; by **soybeanfe** [<samp>(00b07)</samp>](https://github.com/soybeanjs/soybean-ui/commit/00b07cc4a)
  - fix template deps versions &nbsp;-&nbsp; by **soybeanfe** [<samp>(a8921)</samp>](https://github.com/soybeanjs/soybean-ui/commit/a892179a3)
- **styles**:
  - update dialog and drawer styles for responsiveness &nbsp;-&nbsp; by @soybeanjs [<samp>(098e7)</samp>](https://github.com/soybeanjs/soybean-ui/commit/098e76ea2)
- **tests**:
  - update component names in fetcher integration tests &nbsp;-&nbsp; by @soybeanjs [<samp>(2ba39)</samp>](https://github.com/soybeanjs/soybean-ui/commit/2ba395926)
  - remove redundant preset application tests &nbsp;-&nbsp; by **soybeanfe** [<samp>(d525a)</samp>](https://github.com/soybeanjs/soybean-ui/commit/d525a4976)
- **theme**:
  ...
  - move size property to theme object in configProviderProps &nbsp;-&nbsp; by @soybeanjs [<samp>(c0b7c)</samp>](https://github.com/soybeanjs/soybean-ui/commit/c0b7c1a1a)
- **vite**:
...
- **vite.config**:
  - disable minification for better debugging &nbsp;-&nbsp; by **soybeanfe** [<samp>(ee455)</samp>](https://github.com/soybeanjs/soybean-ui/commit/ee4552627)
  - add formatting step to build:docs command &nbsp;-&nbsp; by **soybeanfe** [<samp>(d7e62)</samp>](https://github.com/soybeanjs/soybean-ui/commit/d7e629078)

### &nbsp;&nbsp;&nbsp;🛠 Optimizations

- **docs**:
  - remove table of contents and update import statements &nbsp;-&nbsp; by @soybeanjs [<samp>(5f954)</samp>](https://github.com/soybeanjs/soybean-ui/commit/5f9544d54)
  - enhance build:registry script for formatting &nbsp;-&nbsp; by @soybeanjs [<samp>(b9c2f)</samp>](https://github.com/soybeanjs/soybean-ui/commit/b9c2fd56d)
- **imports**:
  - update type imports to remove .js extension across components &nbsp;-&nbsp; by **soybeanfe** [<samp>(c43e8)</samp>](https://github.com/soybeanjs/soybean-ui/commit/c43e87f6a)
- **navigation-menu**:
  - enhance viewport positioning with active trigger element and add transition effects &nbsp;-&nbsp; by **soybeanfe** [<samp>(02dfc)</samp>](https://github.com/soybeanjs/soybean-ui/commit/02dfc0fe3)
- **sbean**:
  - update sbean &nbsp;-&nbsp; by **soybeanfe** [<samp>(cdd18)</samp>](https://github.com/soybeanjs/soybean-ui/commit/cdd188f5d)
...
- **schema**:
  - remove useless registry-item.json schema file &nbsp;-&nbsp; by **soybeanfe** [<samp>(e9ecb)</samp>](https://github.com/soybeanjs/soybean-ui/commit/e9ecbb6e7)
- **scripts**:
  - update scripts for consistency and clarity &nbsp;-&nbsp; by @soybeanjs [<samp>(6de36)</samp>](https://github.com/soybeanjs/soybean-ui/commit/6de36cd19)
- **theme**:
...
- **build**:
  - streamline build tasks and add prepare script &nbsp;-&nbsp; by @soybeanjs [<samp>(da282)</samp>](https://github.com/soybeanjs/soybean-ui/commit/da28233fb)
- **config-provider**:
  - simplify theme handling and improve CSS generation &nbsp;-&nbsp; by @soybeanjs [<samp>(11aff)</samp>](https://github.com/soybeanjs/soybean-ui/commit/11afffe41)
- **docs**:
  - update import paths to use tilde prefix &nbsp;-&nbsp; by @soybeanjs [<samp>(fd373)</samp>](https://github.com/soybeanjs/soybean-ui/commit/fd373d877)
- **projects**:
  - refactor code structure &nbsp;-&nbsp; by @soybeanjs [<samp>(3dd67)</samp>](https://github.com/soybeanjs/soybean-ui/commit/3dd679f66)
- **sbean**:
...
- **skills**:
  - move skill source to top-level `skills` directory &nbsp;-&nbsp; by **soybeanfe** [<samp>(cbe33)</samp>](https://github.com/soybeanjs/soybean-ui/commit/cbe33c20b)
- **template**:
  - simplify templates and update dependencies &nbsp;-&nbsp; by @soybeanjs [<samp>(c2b4f)</samp>](https://github.com/soybeanjs/soybean-ui/commit/c2b4fa10f)
- **theme**:
  - simplify preset handling and cache logic &nbsp;-&nbsp; by @soybeanjs [<samp>(db519)</samp>](https://github.com/soybeanjs/soybean-ui/commit/db5191842)
  - refactor ui theme configurator &nbsp;-&nbsp; by **soybeanfe** [<samp>(979e9)</samp>](https://github.com/soybeanjs/soybean-ui/commit/979e93989)
  - remove unused radius values from theme radius definitions &nbsp;-&nbsp; by **soybeanfe** [<samp>(54181)</samp>](https://github.com/soybeanjs/soybean-ui/commit/5418133f0)
  ...
  - update Shadcn preset options and improve CSS generation logic &nbsp;-&nbsp; by **soybeanfe** [<samp>(085ea)</samp>](https://github.com/soybeanjs/soybean-ui/commit/085ea9265)

### &nbsp;&nbsp;&nbsp;📦 Build

- **unocss-shadcn**: add lightningcss as a dev dependency &nbsp;-&nbsp; by @soybeanjs [<samp>(4f4d4)</samp>](https://github.com/soybeanjs/soybean-ui/commit/4f4d41d2c)

### &nbsp;&nbsp;&nbsp;🏡 Chore

- **config**:
  - update typecheck command and add type-check task &nbsp;-&nbsp; by @soybeanjs [<samp>(0ad22)</samp>](https://github.com/soybeanjs/soybean-ui/commit/0ad226b80)
- **deps**:
  - update deps &nbsp;-&nbsp; by @soybeanjs [<samp>(94835)</samp>](https://github.com/soybeanjs/soybean-ui/commit/94835dab3)
  - update deps &nbsp;-&nbsp; by **soybeanfe** [<samp>(31a20)</samp>](https://github.com/soybeanjs/soybean-ui/commit/31a20e6bf)
  - update deps &nbsp;-&nbsp; by **soybeanfe** [<samp>(bde98)</samp>](https://github.com/soybeanjs/soybean-ui/commit/bde9842d2)
  - update deps &nbsp;-&nbsp; by **soybeanfe** [<samp>(0c4c5)</samp>](https://github.com/soybeanjs/soybean-ui/commit/0c4c505fa)
  - add vite-plus dependency to package.json and pnpm-lock.yaml &nbsp;-&nbsp; by @soybeanjs [<samp>(34277)</samp>](https://github.com/soybeanjs/soybean-ui/commit/34277adc1)
- **sbean**:
  - remove private flag from package.json &nbsp;-&nbsp; by @soybeanjs [<samp>(ce88d)</samp>](https://github.com/soybeanjs/soybean-ui/commit/ce88d34ac)
- **ui**:
  - remove unused cssRawPlugin function and clean up imports &nbsp;-&nbsp; by **soybeanfe** [<samp>(927d9)</samp>](https://github.com/soybeanjs/soybean-ui/commit/927d91e60)
- **vscode**:
  - update unocss root path &nbsp;-&nbsp; by @soybeanjs [<samp>(047b3)</samp>](https://github.com/soybeanjs/soybean-ui/commit/047b3c816)

### &nbsp;&nbsp;&nbsp;🎨 Styles

- **components**:
  - simplify object property shorthand in form-field and tags-input components &nbsp;-&nbsp; by @soybeanjs [<samp>(8b585)</samp>](https://github.com/soybeanjs/soybean-ui/commit/8b585a940)
- **docs**:
  - remove unused CSS import and format presets in uno.config &nbsp;-&nbsp; by @soybeanjs [<samp>(e28d0)</samp>](https://github.com/soybeanjs/soybean-ui/commit/e28d03625)
  - add UI attributes to the HTML tag for improved styling &nbsp;-&nbsp; by @soybeanjs [<samp>(d7e71)</samp>](https://github.com/soybeanjs/soybean-ui/commit/d7e71961b)
