...
4. 更新 `apps/docs/src/constants/menus.ts`
...
- API 生成产物以脚本输出为准，不要手改 `apps/docs/src/generated/api/` 或 `apps/docs/src/generated/api-locales/`
- changelog 生成产物以脚本输出为准，不要手改 `apps/docs/src/generated/changelog/` 或 `apps/docs/src/generated/changelog-locales/`

## 菜单注册

写完文档后，必须同步更新 `apps/docs/src/constants/menus.ts`：
...
- 文档中的演示展示面要和 `apps/playground/src/examples/{component}/` 真实文件保持一致
- 标题与 API 内容不要落后于实现
