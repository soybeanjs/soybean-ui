...
<template>
  <NavigationMenuItem v-bind="itemProps" :value="item.value">
    ...
    >
      <NavigationMenuItemSlot :icon="item.icon" :label="item.label">
        ...
        <NavigationMenuSub v-bind="subProps" @update:model-value="emit('update:modelValue', $event)">
          <NavigationMenuList v-bind="subListProps">
            <NavigationMenuSubOption
              ...
              :sub-list-props="subListProps"
              :sub-viewport-props="subViewportProps"
              :sub-indicator-props="subIndicatorProps"
