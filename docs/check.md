...
> **批次 3 合计：** 5 个检查单元通过 D1–D7 全维度；单测 6 → 123 项（+117）；`pnpm typecheck` / `pnpm lint` 全绿；族系回归（date-field/date-picker/date-range-field/date-range-picker/time-field 等 106/106）全通过。
