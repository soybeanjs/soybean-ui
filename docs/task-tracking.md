...
>
> 基线生成：2026-08-14（基线分支 `main`）。
>
> **2026-09 更新：W2（UX-\*，ui-x）任务全部取消**——`@soybeanjs/ui-x` 整包移除，AI/chat 组件在核心 headless/ui 重新实现，新跟踪以 [ui-ai-roadmap.md](./ui-ai-roadmap.md) 为准；相关行保留作历史记录。admin / chart 行同属历史（v0.40.0 已取消）。
