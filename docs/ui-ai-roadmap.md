...
>
> 编制依据（2026-09 重新探索）：`vuepont/ai-elements-vue`、`element-plus-x/Element-Plus-X`（v2）、`antdv-next/x`（v1.2）、`assistant-ui` primitives/runtime，以及本仓库 `.agents/skills/vean-develop/` 的 aria 准入纪律（R1–R8）。
>
