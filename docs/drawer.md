...
| D3.4 | 真机验证:iOS Safari / Android Chrome / 移动 Firefox,滚动让位、双指缩放豁免、键盘弹起场景                                                                                                                         | 三平台核心手势无回退                                      | ⬜(进行中:iOS 首轮已定位并修复「首开瞬态高度→动画纠正」,待三平台复验) |
