# <i18n-t keypath="components.button.title" />

<i18n-t keypath="components.button.desc" />

## <i18n-t keypath="components.common.demo" />
...
| shadow     | `none`    | `sm`        | `md`                 | `lg`      | `sm`      | 阴影效果 |
| fitContent | `boolean` | `false`     | 根据内容自适应尺寸   |
| disabled   | `boolean` | `false`     | 是否禁用             |
| as         | `string`  | `button`    | 渲染元素类型         |
| asChild    | `boolean` | `false`     | 使用子元素作为渲染根 |
