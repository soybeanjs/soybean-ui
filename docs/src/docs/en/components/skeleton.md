...
<DataTable preset="props" :data="[
  ...
  { name: 'shape', type: 'SkeletonShape', default: '`rounded`', description: 'Preset corner shape.' },
...
<UnionType name="SkeletonShape" description="Skeleton shape type" type="'rounded' | 'pill' | 'square'" />
