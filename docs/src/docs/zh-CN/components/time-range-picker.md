...
<DataTable preset="props" :data="[
  ...
  { name: 'modelValue', type: 'TimeRange', default: '-', description: '受控时间区间值。' },
  { name: 'defaultValue', type: 'TimeRange', default: '-', description: '非受控初始时间区间值。' },
  ...
  { name: 'ui', type: 'Partial<TimeRangePickerUi>', default: '{}', description: '覆盖内部 slot 类名。' },
  { name: 'triggerProps', type: 'TimeRangePickerTriggerProps', default: '{}', description: '透传给 trigger 的 props。' },
  { name: 'popupProps', type: 'TimeRangePickerPopupProps', default: '{}', description: '透传给 popup 的 props。' }
]"/>

### 事件

<DataTable preset="emits" :data="[
  { name: 'update:modelValue', parameters: '(value: TimeRange) => void', description: '选中时间区间变化时触发。' },
...
<DataTable preset="slots" :data="[
  { name: 'trigger', parameters: '{ displayValue: string; modelValue: TimeRange; open: boolean }', description: '自定义 trigger 内容。' },
  { name: 'time', parameters: '{ disabled: boolean; focused: boolean; highlighted: boolean; label: string; rangeStart: boolean; rangeEnd: boolean; selected: boolean; time: TimeValue }', description: '自定义弹层时间选项内容。' },
  { name: 'default', parameters: '{ displayValue: string; modelValue: TimeRange; open: boolean }', description: '在根节点内追加的内容。' }
]"/>
