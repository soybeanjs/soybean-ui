...
<DataTable preset="props" :data="[
  ...
  { name: 'color', type: 'ToggleColor', default: `'accent'`, description: '颜色。' },
...
<UnionType name="ToggleColor" description="Toggle 颜色" type="'primary' | 'destructive' | 'success' | 'warning' | 'info' | 'carbon' | 'secondary' | 'accent'" />

<UnionType name="ToggleVariant" description="Toggle 变体" type="'outline' | 'soft' | 'ghost'" />

<UnionType name="ToggleShape" description="Toggle 形状" type="'auto' | 'rounded' | 'square' | 'circle'" />

<UnionType name="ThemeSize" description="Toggle 尺寸" type="'xs' | 'sm' | 'md' | 'lg' | 'xl' | '2xl'" />
