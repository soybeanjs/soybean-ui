...
<DataTable preset="props" :data="[
  ...
  { name: 'name', type: 'string', default: '-', description: '参与表单提交时使用的字段名。' },
  { name: 'required', type: 'boolean', default: 'false', description: '所属表单是否要求至少提供一个值。' },
  { name: 'thumbAlignment', type: '`contain` | `overflow`', default: '`contain`', description: '滑块拇指是否限制在轨道边界内。' },
