...
- Generated changelog data lives in `docs/src/generated/changelog/` and `docs/src/generated/changelog-locales/`; changelog mapping, release presentation, or locale template changes require `pnpm sui changelog` and, for non-English locales, `pnpm sui changelog-translate -- --locale <locale>`
