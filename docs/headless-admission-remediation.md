...
| D 平行家族                  | 1 对 | 待决策：合并或划清领域         | CMP-6.4 |
| 明确合规、不要当违规        |  —   | 已合规                         | —       |
...
| ID     | 组件                            | 证据                                                                                                                                 | 违反 | 处置                                                                                     | 状态 |
| :----- | :------------------------------ | :----------------------------------------------------------------------------------------------------------------------------------- | :--- | :--------------------------------------------------------------------------------------- | :--: |
| HAD-D1 | `nav-menu` vs `navigation-menu` | 两者 Root props 同构（`modelValue`、`delayDuration`、`orientation`、hover/click 开关）。Radix / Base / Reka 只有一套 Navigation Menu | R6   | 待决策：合并到一个家族，或写出不可互相替代的领域差（例如应用壳导航 vs 站点导航）后再保留 |  ⬜  |
...
| CMP-6.4 | HAD-D1 Navigation Menu 合并或领域差 ADR                                       | 0.5d 决策 + 实施另估 | Soybean 决策        |
