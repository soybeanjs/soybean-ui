...
- **「这个组件该不该做 aria / 现有哪些违规」** → skill [layers.md Aria admission](../.agents/skills/vean-ui-develop/layers.md#aria-admission) → [aria-admission-remediation.md](./aria-admission-remediation.md)
