...
│   ├── README.md        # ADR 索引与模板
│   └── NNNN-*.md
├── ecosystem/           # 未来提案（editor / table / form / ui-pro / vean / 商业化）
...
| **准入整改**   | [aria-admission-remediation.md](./aria-admission-remediation.md)                      | aria 准入违规组件级清单                                     | 组件开发者         |
| **决策记录**   | [adr/](./adr/README.md)                                                               | 架构决策（含已 superseded 的外围包分层 ADR）                | 架构师             |
| **未来提案**   | [ecosystem/](./ecosystem/README.md)（editor / table / form / ui-pro / vean / 商业化） | 方向调研；落地形态（核心内 / 独立包 / vean 配方）立项时评估 | 规划者、生态开发者 |
