...
├── enhanced-popper.md   # Enhanced Popper 设计方案（触发 / 嵌套 / 壳层收敛）
...
| **路线与规划** | [roadmap.md](./roadmap.md) · [components.md](./components.md) · [enhanced-popper.md](./enhanced-popper.md)                                                   | 总路线图 + 组件评估 + 浮层壳层方案 | 规划者、贡献者 |
