...
<template>
  <div>
    ...
    <SCarousel aria-label="Vertical carousel" orientation="vertical" class="mx-auto h-80 w-full max-w-xs">
      <SCarouselContent class="h-full">
        <SCarouselItem v-for="slide in slides" :key="slide">
          <div class="p-1 h-full">
            <SCard :ui="{ content: 'h-full min-h-24 flex items-center justify-center p-6' }">
