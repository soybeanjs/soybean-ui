...
import DemoAlertDialogDestructive from './destructive.vue';
...
<template>
  <SCard title="Alert Dialog" split :ui="{ content: 'flex-c gap-4' }">
    <DemoAlertDialogDestructive />
    <DemoAlertDialogInfo />
    <DemoAlertDialogSuccess />
    <DemoAlertDialogWarning />
    <DemoAlertDialogAction />
  </SCard>
</template>
