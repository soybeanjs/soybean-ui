...
/**
 * Given a `values` array and a `nextValue`, determine which value in the array is closest to `nextValue` and return its
 * index.
 *
 * @example
 *   // returns 1
...
/**
 * Offsets the thumb centre point while sliding to ensure it remains within the bounds of the slider when reaching the
 * edges
 */
...
/**
 * Verifies the minimum steps between all values is greater than or equal to the expected minimum steps.
 *
 * @example
 *   // returns false
