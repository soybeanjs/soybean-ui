import type { DateSegmentPart, EditableSegmentPart } from './types';
...
const placeholderFields: DateSegmentPart[] = ['year', 'month', 'day'];

export type PlaceholderMap = Record<SupportedLocale, Record<DateSegmentPart, string>>;
...
type Field = 'era' | EditableSegmentPart;
...
function isPlaceholderField(field: unknown): field is DateSegmentPart {
  return placeholderFields.includes(field as DateSegmentPart);
}
