...
export const treeMenuVariants = scv({
  ...
  slots: {
    root: 'group flex-1 flex flex-col w-full h-full overflow-auto text-sidebar-foreground data-[state=collapsed]:w-[--vean-tree-menu-collapsed-width] transition-[width,height]-200 ease-out',
