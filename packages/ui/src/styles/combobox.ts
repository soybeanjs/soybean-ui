...
export const comboboxVariants = scv({
  slots: {
    ...
    clear: [
      'flex shrink-0 items-center justify-center rounded-sm bg-transparent text-muted-foreground opacity-70',
      'outline-none transition-colors hover:bg-accent hover:text-accent-foreground hover:opacity-100',
