...
export const switchVariants = scv({
  slots: {
    ...
    control: [
      ...
      `outline-none focus-visible:ring-3 focus-visible:ring-offset-card disabled:cursor-not-allowed disabled:opacity-50 data-[state=unchecked]:bg-input`
    ],
    thumb: [
      `flex justify-center items-center rounded-full shadow-lg transition-transform-200 bg-card pointer-events-none`,
