...
6. `.github/instructions/soybean-ui-ui-layer.instructions.md`
...
- Public UI export changes must be reflected in `packages/ui/src/index.ts`, then synced via `pnpm sui ui` to update `packages/ui/src/constants/components.ts`
