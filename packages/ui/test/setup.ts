...
// animation fires its "finish" event. happy-dom ≥20.13 ships a partial Web Animations
// API whose animations never fire "finish" (and reject `finished` with AbortError on
// teardown), so leaving elements linger in the DOM. Always stub it with a shim that
// fires "finish" immediately — this file only runs in the happy-dom unit environment,
// browser e2e uses real Chromium.
