...
import SLayoutClassic from '@/components/layout/layout-classic.vue';
...
describe('SLayout', () => {
  describe('rendering', () => {
    ...
    it('renders header, tab, and footer slots', () => {
      const wrapper = mount(SLayout, {
        slots: {
  ...
  describe('state reflection', () => {
    it('reflects expanded state via data-state on root', () => {
      const wrapper = mount(SLayout, {
    ...
    it('reflects collapsed state via data-state on root', () => {
      const wrapper = mount(SLayout, {
    ...
    it('reflects data-collapsible attribute when collapsed', () => {
      const wrapper = mount(SLayout, {
      ...
      expect(wrapper.find('[data-soybean-layout-root]').attributes('data-collapsible')).toBe('offcanvas');
    ...
    it('supports v-model:open', async () => {
      const wrapper = mount(SLayout, {
        props: { open: true, 'onUpdate:open': (v: boolean) => wrapper.setProps({ open: v }) },
        slots: {
          sidebar: '<div>Sidebar</div>',
          default: '<div>Main</div>'
        },
...
describe('SLayoutClassic', () => {
  describe('rendering', () => {
    it('renders with all slots', () => {
      const wrapper = mount(SLayoutClassic, {
        slots: {
          header: '<div data-header>Header</div>',
          tab: '<div data-tab>Tab</div>',
          sidebar: '<div data-sidebar>Sidebar</div>',
      ...
      expect(wrapper.find('[data-soybean-layout-classic-root]').exists()).toBe(true);
      expect(wrapper.find('[data-header]').exists()).toBe(true);
      expect(wrapper.find('[data-tab]').exists()).toBe(true);
      expect(wrapper.find('[data-footer]').exists()).toBe(true);
    ...
    it('applies custom root class', () => {
      ...
      expect(wrapper.find('.my-classic-layout').exists()).toBe(true);
  ...
  describe('state reflection', () => {
    it('reflects data-orientation attribute', () => {
      ...
      expect(wrapper.find('[data-soybean-layout-classic-root]').attributes('data-orientation')).toBe('vertical');
    ...
    it('reflects data-scroll-behavior attribute', () => {
      ...
      expect(wrapper.find('[data-soybean-layout-classic-root]').attributes('data-scroll-behavior')).toBe('wrapper');
    ...
    it('reflects data-fixed-top attribute', () => {
      ...
      expect(wrapper.find('[data-soybean-layout-classic-root]').attributes('data-fixed-top')).toBe('true');
    ...
    it('reflects data-fixed-footer attribute', () => {
      ...
      expect(wrapper.find('[data-soybean-layout-classic-root]').attributes('data-fixed-footer')).toBe('true');
    ...
    it('reflects expanded/collapsed state via data-state', () => {
      ...
      expect(wrapper.find('[data-soybean-layout-classic-root]').attributes('data-state')).toBe('expanded');
    ...
    it('reflects data-stretch-footer attribute', () => {
      ...
      expect(wrapper.find('[data-soybean-layout-classic-root]').attributes('data-stretch-footer')).toBe('false');
  ...
  describe('fullContent', () => {
    it('reflects data-full-content attribute', () => {
      ...
      expect(wrapper.find('[data-soybean-layout-classic-root]').attributes('data-full-content')).toBe('true');
