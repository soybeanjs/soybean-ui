 ...
 * Teleport structure. This spec covers first-level Arrow/Enter selection and
...
describe('SSplitNav (e2e)', () => {
  describe('keyboard', () => {
    it('moves first-level focus with ArrowDown and selects with Enter', async () => {
      ...
      await expect.element(workspace).toHaveAttribute('data-state', 'active');
