...
1. Load the component development skill at `.agents/skills/vean-develop/` — specifically [e2e.md](../../../../../.agents/skills/vean-develop/e2e.md) for browser e2e design principles, core scenarios, assertion standards, and env setup.
...
Use this file only as routing and local path context. Normative e2e rules live in [e2e.md](../../../../../.agents/skills/vean-develop/e2e.md).
