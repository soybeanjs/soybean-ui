...
export const dialogVariants = tv({
  slots: {
    ...
    content: [
      `fixed left-[50%] top-[50%] z-50 w-full max-w-lg gap-4 border bg-background px-6 py-5 shadow-lg translate-x-[-50%] translate-y-[-50%] md:w-full duration-200 sm:rounded-lg`,
