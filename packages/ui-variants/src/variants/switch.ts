...
export const switchVariants = tv({
  base: [],
  slots: {
    root: 'peer inline-flex shrink-0  items-center  border-2 border-transparent shadow-sm transition-colors focus-visible:(outline outline-2 outline-offset-2) disabled:(cursor-not-allowed opacity-50) data-[state=unchecked]:bg-input',
    thumb:
