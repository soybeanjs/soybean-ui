...
export const checkboxVariants = tv({
  ...
  variants: {
    color: {
      ...
      secondary: {
        control: `border-secondary-foreground focus-visible:outline-secondary-foreground/20 data-[state=checked]:(bg-secondary text-secondary-foreground) data-[state=indeterminate]:(bg-secondary text-secondary-foreground)`
      },
      accent: {
        control: `border-accent-foreground focus-visible:outline-accent-foreground/20 data-[state=checked]:(bg-accent text-accent-foreground) data-[state=indeterminate]:(bg-accent text-accent-foreground)`
      }
    },
    orientation: {
      horizontal: {
