...
import { FormItem, FormMessage } from '@ui/components/ui/form';
...
const itemShape = computed(() => {
  ...
  let schema: z.ZodAny | undefined;

  if (isZodArray(props.schema)) {
    schema = props.schema._def.type;
  } else if (isZodDefault(props.schema)) {
    // @ts-expect-error missing schema
    schema = props.schema._def.innerType._def.type;
  }
