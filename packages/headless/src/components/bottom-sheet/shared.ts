...
export const DRAG_CLASS = 'soybean-bottom-sheet-dragging';

export const NO_DRAG_ATTR = 'data-soybean-bottom-sheet-no-drag';

export const BOTTOM_SHEET_SCALE_SELECTOR = 'data-soybean-bottom-sheet-scale';
