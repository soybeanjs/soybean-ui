...
export function createPopperV2PositionerDefaultProps() {
  const props: InferDefaults<PopperV2PositionerProps> = {
    placement: undefined,
    side: 'bottom',
    sideOffset: 0,
    sideFlip: true,
...
export function getFloatingUiMiddleware(props: PopperV2PositionerProps, arrowElement: Element | null | undefined) {
  const {
    sideOffset = 0,
    alignOffset = 0,
    sideFlip,
...
function getDetectOverflowOptions(props: PopperV2PositionerProps) {
