 ...
 */
export interface PopperV2PositioningRootProps {
  /**
 ...
 * use `PopperV2AnchorProps` / `PopperV2ArrowProps` for both.
 */

/**
 * Properties for the positioning-only positioner. Same positioning surface as
 * `PopperV2PositionerProps` minus the interactive-shell concerns (presence, focus trap,
 ...
 */
export interface PopperV2PositioningPositionerProps extends BaseProps {
  /**
...
export type PopperV2PositioningPositionerEmits = {
 ...
 */
export interface PopperV2PositioningPopupProps extends BaseProps {}
