export { default as ColorSwatchPickerCompact } from './color-swatch-picker-compact.vue';
...
export type {
  ...
  ColorSwatchPickerCompactSlotProps,
  ColorSwatchPickerCompactColorSlotProps,
