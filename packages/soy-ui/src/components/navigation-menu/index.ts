import { NavigationMenuSub as SNavigationMenuSub } from '@soybean-ui/primitives';
import SNavigationMenuChildLinkDescription from './navigation-menu-child-link-description.vue';
import SNavigationMenuChildLinkLabel from './navigation-menu-child-link-label.vue';
