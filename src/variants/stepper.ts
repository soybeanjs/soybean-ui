...
export const stepperVariants = tv({
  slots: {
    ...
    trigger: `shrink-0 flex flex-col items-center text-center z-10 data-[state=active]:ring-3 data-[state=active]:ring-primary/30 data-[state=active]:ring-offset-background`
  },
  variants: {
    size: {
      xs: {
