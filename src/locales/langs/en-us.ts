  ...
  page: {
    ...
    home: {
      ...
      projectNews: {
        title: 'Project News',
        moreNews: 'More News',
        desc1: 'Soybean created the open source project soybean-unify on May 28, 2021!',
        desc2: 'Yanbowe submitted a bug to soybean-unify, the multi-tab bar will not adapt.',
        desc3: 'Soybean is ready to do sufficient preparation for the release of soybean-unify!',
        desc4: 'Soybean is busy writing project documentation for soybean-unify!',
