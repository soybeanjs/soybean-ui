  ...
  page: {
    ...
    home: {
      ...
      projectNews: {
        title: '项目动态',
        moreNews: '更多动态',
        desc1: 'Soybean 在2021年5月28日创建了开源项目 soybean-unify!',
        desc2: 'Yanbowe 向 soybean-unify 提交了一个bug，多标签栏不会自适应。',
        desc3: 'Soybean 准备为 soybean-unify 的发布做充分的准备工作!',
        desc4: 'Soybean 正在忙于为soybean-unify写项目说明文档！',
