...
import { SAlertDialog, SAlertDialogAction, SAlertDialogCancel, SButton } from 'soybean-ui';
...
<template>
  <div class="py-12px text-18px">Destructive</div>
  ...
  <div class="py-12px text-18px">Warning</div>
  ...
  <div class="py-12px text-18px">Info</div>
