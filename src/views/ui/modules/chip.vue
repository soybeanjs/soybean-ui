...
import type { ChipPosition, SChip, SInput, ThemeColor, ThemeSize } from 'soybean-ui';
import { ref } from 'vue';
...
<template>
  ...
  <div class="w-320px lt-sm:w-auto">
    ...
    <div class="flex gap-4">
      <div v-for="color in colors" :key="color">
        <SChip :color="color" size="xl" text="99+">
          <SButton variant="dashed">{{ color }}</SButton>
        </SChip>
      </div>
    </div>
