...
export const yearPickerVariants = tv({
  slots: {
    ...
    heading: 'text-center font-medium text-foreground',
    prev: [
...
type YearPickerVariants = VariantProps<typeof yearPickerVariants>;

export type YearPickerVariantProps = YearPickerVariants;
