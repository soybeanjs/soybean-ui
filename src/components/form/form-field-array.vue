...
import { FormDescription, FormError, FormFieldArray, FormLabel, provideFormFieldUi } from '@soybeanjs/headless';
...
const ui = computed(() => {
  ...
  return mergeSlotVariants(variants, formContext.ui.value, props.ui, { fieldArray: props.class });
});
