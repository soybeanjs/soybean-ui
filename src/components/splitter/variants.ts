...
export const splitterVariants = tv({
  slots: {
    ...
    resizeHandle: [
      ...
      'after:start-1/2 after:w-1 after:-translate-x-1/2 outline-none focus-visible:ring-1 focus-visible:ring-offset-1',
      'data-[state=hover]:bg-accent data-[state=drag]:bg-accent',
      'data-[disabled]:cursor-not-allowed data-[disabled]:opacity-60',
      'data-[orientation=vertical]:h-px data-[orientation=vertical]:w-full',
      'data-[orientation=vertical]:cursor-row-resize',
      'data-[orientation=vertical]:after:start-0 data-[orientation=vertical]:after:h-1 data-[orientation=vertical]:after:w-full',
