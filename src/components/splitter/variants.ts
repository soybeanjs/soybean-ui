...
export const splitterVariants = tv({
  slots: {
    ...
    resizeHandle: [
      'bg-border focus-visible:ring-ring relative flex w-px cursor-col-resize items-center justify-center transition-colors-200 after:absolute after:inset-y-0',
