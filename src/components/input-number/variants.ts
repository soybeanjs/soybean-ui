...
export const inputNumberVariants = tv({
  slots: {
    root: 'group flex items-center w-full rounded-md border border-input bg-background transition-shadow-150 focus-within:border-input focus-within:ring-3  focus-within:ring-offset-background focus-within:ring-primary/30 disabled:cursor-not-allowed disabled:opacity-50',
