...
export const dialogVariants = tv({
  slots: {
    ...
    content: [
      `fixed left-[50%] top-[50%] z-50 flex flex-col w-max lt-sm:min-w-full lt-sm:max-w-full border bg-background shadow-lg outline-none translate-x-[-50%] translate-y-[-50%] duration-200 rounded-lg`,
  ...
  variants: {
    size: {
      xs: {
        content: `gap-y-1.5 min-w-xs max-w-3xl px-2 py-1.5 text-2xs`,
        header: 'gap-y-1.5',
      ...
      sm: {
        content: `gap-y-2 min-w-sm max-w-4xl px-3 py-2 text-xs`,
        header: 'gap-y-2',
      ...
      md: {
        content: `gap-y-3 min-w-md max-w-5xl px-4 py-3 text-sm`,
        header: 'gap-y-3',
      ...
      lg: {
        content: `gap-y-4 min-w-lg max-w-6xl px-5 py-4 text-base`,
        header: 'gap-y-4',
      ...
      xl: {
        content: `gap-y-5 min-w-xl max-w-7xl px-6 py-5 text-lg`,
        header: 'gap-y-5',
      ...
      '2xl': {
        content: `gap-y-6 min-w-2xl max-w-7xl px-7 py-6 text-xl`,
        header: 'gap-y-6',
