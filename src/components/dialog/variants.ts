...
export const dialogVariants = tv({
  slots: {
    ...
    popup: [
      `group fixed start-1/2 top-1/2 z-50 flex flex-col w-max lt-sm:w-full max-h-80vh lt-md:max-h-60vh border bg-background shadow-lg outline-none duration-200 rounded-lg`,
