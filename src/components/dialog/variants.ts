...
export const dialogVariants = tv({
  slots: {
    ...
    content: [
      `fixed left-[50%] top-[50%] z-50 flex flex-col w-full border bg-background shadow-lg outline-none translate-x-[-50%] translate-y-[-50%] md:w-full duration-200 rounded-lg`,
