  ...
  variants: {
    size: {
      xs: {
        ...
        popup: 'w-[--soybean-combobox-trigger-width] text-2xs',
      ...
      sm: {
        ...
        popup: 'w-[--soybean-combobox-trigger-width] text-xs',
      ...
      md: {
        ...
        triggerIcon: 'text-xs',
        popup: 'w-[--soybean-combobox-trigger-width] text-sm',
      ...
      lg: {
        ...
        triggerIcon: 'text-sm',
        popup: 'w-[--soybean-combobox-trigger-width] text-base',
      ...
      xl: {
        ...
        popup: 'w-[--soybean-combobox-trigger-width] text-lg',
      ...
      '2xl': {
        ...
        triggerIcon: 'text-lg',
        popup: 'w-[--soybean-combobox-trigger-width] text-xl',
