...
export const tabsVariants = tv({
  slots: {
    ...
    content: `flex-grow self-stretch transition-all-150 focus-visible:outline-none focus-visible:ring-3  focus-visible:ring-offset-background focus-visible:ring-primary/30`
  },
  variants: {
    size: {
      xs: {
